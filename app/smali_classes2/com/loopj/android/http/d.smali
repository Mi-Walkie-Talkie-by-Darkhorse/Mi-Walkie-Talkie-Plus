...
# interfaces
.implements Lcom/loopj/android/http/i;
...
.method public constructor <init>(Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/loopj/android/http/d;->responseCharset:Ljava/lang/String;

    iput-object v1, p0, Lcom/loopj/android/http/d;->requestURI:Ljava/net/URI;

    iput-object v1, p0, Lcom/loopj/android/http/d;->requestHeaders:[Lorg/apache/http/Header;

    iput-object v1, p0, Lcom/loopj/android/http/d;->looper:Landroid/os/Looper;
    ...
    :cond_0
    iput-object p1, p0, Lcom/loopj/android/http/d;->looper:Landroid/os/Looper;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/loopj/android/http/d;->setUseSynchronousMode(Z)V
...
.method public getCharset()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/loopj/android/http/d;->responseCharset:Ljava/lang/String;
...
.method public getRequestHeaders()[Lorg/apache/http/Header;
    ...
    iget-object v0, p0, Lcom/loopj/android/http/d;->requestHeaders:[Lorg/apache/http/Header;
...
.method public getRequestURI()Ljava/net/URI;
    ...
    iget-object v0, p0, Lcom/loopj/android/http/d;->requestURI:Ljava/net/URI;
...
.method getResponseData(Lorg/apache/http/HttpEntity;)[B
    ...
    invoke-virtual {p0, v4, v0}, Lcom/loopj/android/http/d;->sendProgressMessage(II)V
    :try_end_1
...
.method public getUseSynchronousMode()Z
    ...
    iget-boolean v0, p0, Lcom/loopj/android/http/d;->useSynchronousMode:Z
...
.method protected handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lcom/loopj/android/http/d;->onSuccess(I[Lorg/apache/http/Header;[B)V
    ...
    invoke-virtual {p0, v3, v1, v2, v0}, Lcom/loopj/android/http/d;->onFailure(I[Lorg/apache/http/Header;[BLjava/lang/Throwable;)V
    ...
    :pswitch_2
    invoke-virtual {p0}, Lcom/loopj/android/http/d;->onStart()V

    goto :goto_0

    :pswitch_3
    invoke-virtual {p0}, Lcom/loopj/android/http/d;->onFinish()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/loopj/android/http/d;->onProgress(II)V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lcom/loopj/android/http/d;->onRetry(I)V
    ...
    :pswitch_6
    invoke-virtual {p0}, Lcom/loopj/android/http/d;->onCancel()V
...
.method protected obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v0, p0, Lcom/loopj/android/http/d;->handler:Landroid/os/Handler;
...
.method public onPostProcessResponse(Lcom/loopj/android/http/i;Lorg/apache/http/HttpResponse;)V
    .locals 0

    return-void
.end method

.method public onPreProcessResponse(Lcom/loopj/android/http/i;Lorg/apache/http/HttpResponse;)V
    .locals 0
...
.method protected postRunnable(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0}, Lcom/loopj/android/http/d;->getUseSynchronousMode()Z
...
.method public final sendCancelMessage()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/loopj/android/http/d;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/loopj/android/http/d;->sendMessage(Landroid/os/Message;)V
...
.method public final sendFailureMessage(I[Lorg/apache/http/Header;[BLjava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v3, v0}, Lcom/loopj/android/http/d;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method protected sendMessage(Landroid/os/Message;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/loopj/android/http/d;->handleMessage(Landroid/os/Message;)V
...
.method public sendResponseMessage(Lorg/apache/http/HttpResponse;)V
    ...
    invoke-virtual {p0, v1}, Lcom/loopj/android/http/d;->getResponseData(Lorg/apache/http/HttpEntity;)[B
    ...
    invoke-virtual {p0, v2, v3, v1, v4}, Lcom/loopj/android/http/d;->sendFailureMessage(I[Lorg/apache/http/Header;[BLjava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v0, v2, v1}, Lcom/loopj/android/http/d;->sendSuccessMessage(I[Lorg/apache/http/Header;[B)V
...
.method public final sendSuccessMessage(I[Lorg/apache/http/Header;[B)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/loopj/android/http/d;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public setCharset(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/loopj/android/http/d;->responseCharset:Ljava/lang/String;
...
.method public setRequestHeaders([Lorg/apache/http/Header;)V
    ...
    iput-object p1, p0, Lcom/loopj/android/http/d;->requestHeaders:[Lorg/apache/http/Header;
...
.method public setRequestURI(Ljava/net/URI;)V
    ...
    iput-object p1, p0, Lcom/loopj/android/http/d;->requestURI:Ljava/net/URI;
...
.method public setUseSynchronousMode(Z)V
    ...
    iget-object v0, p0, Lcom/loopj/android/http/d;->looper:Landroid/os/Looper;
    ...
    iget-object v1, p0, Lcom/loopj/android/http/d;->looper:Landroid/os/Looper;

    invoke-direct {v0, p0, v1}, Lcom/loopj/android/http/d$a;-><init>(Lcom/loopj/android/http/d;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/loopj/android/http/d;->handler:Landroid/os/Handler;

    :cond_1
    :goto_0
    iput-boolean p1, p0, Lcom/loopj/android/http/d;->useSynchronousMode:Z
