...
.method constructor <init>(Landroidx/core/app/NotificationCompat$b;)V
    ...
    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->a:Landroid/content/Context;

    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->K:Ljava/lang/String;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Landroidx/core/app/NotificationCompat$b;->S:Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroidx/core/app/NotificationCompat$b;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/NotificationCompat$b;->l:I
    ...
    iget v4, p1, Landroidx/core/app/NotificationCompat$b;->t:I

    iget v9, p1, Landroidx/core/app/NotificationCompat$b;->u:I

    iget-boolean v10, p1, Landroidx/core/app/NotificationCompat$b;->v:Z
    ...
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->q:Ljava/lang/CharSequence;
    ...
    iget-boolean v8, p1, Landroidx/core/app/NotificationCompat$b;->o:Z
    ...
    iget v8, p1, Landroidx/core/app/NotificationCompat$b;->m:I

    .line 32
    invoke-virtual {v0, v8}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    .line 33
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->b:Ljava/util/ArrayList;
    ...
    .line 34
    invoke-direct {p0, v8}, Landroidx/core/app/h;->a(Landroidx/core/app/NotificationCompat$Action;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Landroidx/core/app/h;->f:Landroid/os/Bundle;
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->w:Ljava/lang/String;
    ...
    .line 42
    iget-boolean v0, p1, Landroidx/core/app/NotificationCompat$b;->x:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->y:Ljava/lang/String;
    ...
    .line 48
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->I:Landroid/widget/RemoteViews;
    ...
    iget-boolean v9, p1, Landroidx/core/app/NotificationCompat$b;->n:Z
    ...
    .line 51
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Landroidx/core/app/h;->e(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Landroidx/core/app/NotificationCompat$b;->V:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Landroidx/core/app/h;->d(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Landroidx/core/app/h;->f:Landroid/os/Bundle;
    ...
    iget-boolean v8, p1, Landroidx/core/app/NotificationCompat$b;->z:Z

    invoke-virtual {v4, v8}, Landroid/app/Notification$Builder;->setLocalOnly(Z)Landroid/app/Notification$Builder;

    move-result-object v4

    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->w:Ljava/lang/String;
    ...
    iget-boolean v8, p1, Landroidx/core/app/NotificationCompat$b;->x:Z
    ...
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->y:Ljava/lang/String;

    .line 59
    invoke-virtual {v4, v8}, Landroid/app/Notification$Builder;->setSortKey(Ljava/lang/String;)Landroid/app/Notification$Builder;

    .line 60
    iget v4, p1, Landroidx/core/app/NotificationCompat$b;->P:I
    ...
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->C:Ljava/lang/String;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v8, p1, Landroidx/core/app/NotificationCompat$b;->E:I
    ...
    iget v8, p1, Landroidx/core/app/NotificationCompat$b;->F:I
    ...
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->G:Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroidx/core/app/h;->e(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->V:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Landroidx/core/app/h;->d(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->V:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/h;->h:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Landroidx/core/app/NotificationCompat$b;->d:Ljava/util/ArrayList;
    ...
    .line 80
    invoke-static {v12}, Landroidx/core/app/i;->b(Landroidx/core/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->U:Landroid/graphics/drawable/Icon;
    ...
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->D:Landroid/os/Bundle;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->s:[Ljava/lang/CharSequence;
    ...
    .line 91
    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->H:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->I:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Landroidx/core/app/NotificationCompat$b;->J:Landroid/widget/RemoteViews;
    ...
    iget v9, p1, Landroidx/core/app/NotificationCompat$b;->L:I

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setBadgeIconType(I)Landroid/app/Notification$Builder;

    move-result-object v8

    iget-object v9, p1, Landroidx/core/app/NotificationCompat$b;->r:Ljava/lang/CharSequence;
    ...
    iget-object v9, p1, Landroidx/core/app/NotificationCompat$b;->M:Ljava/lang/String;
    ...
    iget-wide v9, p1, Landroidx/core/app/NotificationCompat$b;->O:J
    ...
    iget v9, p1, Landroidx/core/app/NotificationCompat$b;->P:I

    .line 101
    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    .line 102
    iget-boolean v8, p1, Landroidx/core/app/NotificationCompat$b;->B:Z
    ...
    iget-boolean v9, p1, Landroidx/core/app/NotificationCompat$b;->A:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    .line 104
    :cond_19
    iget-object v8, p1, Landroidx/core/app/NotificationCompat$b;->K:Ljava/lang/String;
    ...
    iget-boolean v7, p1, Landroidx/core/app/NotificationCompat$b;->Q:Z
    ...
    iget-object v7, p1, Landroidx/core/app/NotificationCompat$b;->R:Landroidx/core/app/NotificationCompat$a;

    .line 114
    invoke-static {v7}, Landroidx/core/app/NotificationCompat$a;->c(Landroidx/core/app/NotificationCompat$a;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 116
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$b;->N:Landroidx/core/content/c;
    ...
    .line 117
    :cond_1c
    invoke-virtual {v4}, Landroidx/core/content/c;->a()Landroid/content/LocusId;
...
.method private a(Landroidx/core/app/NotificationCompat$Action;)V
    ...
    .line 31
    invoke-static {v1, p1}, Landroidx/core/app/i;->f(Landroid/app/Notification$Builder;Landroidx/core/app/NotificationCompat$Action;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    .line 2
    invoke-virtual {v0, p0}, Landroidx/core/app/NotificationCompat$c;->b(Landroidx/core/app/g;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Landroidx/core/app/NotificationCompat$c;->d(Landroidx/core/app/g;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Landroidx/core/app/h;->b:Landroidx/core/app/NotificationCompat$b;

    iget-object v4, v4, Landroidx/core/app/NotificationCompat$b;->p:Landroidx/core/app/NotificationCompat$c;

    .line 12
    invoke-virtual {v4, p0}, Landroidx/core/app/NotificationCompat$c;->e(Landroidx/core/app/g;)Landroid/widget/RemoteViews;
...
.method protected c()Landroid/app/Notification;
    ...
    .line 6
    invoke-direct {p0, v0}, Landroidx/core/app/h;->f(Landroid/app/Notification;)V
