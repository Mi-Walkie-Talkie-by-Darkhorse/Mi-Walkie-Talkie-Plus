...
.method public constructor <init>(ILjava/util/Vector;Lorg/bouncycastle/crypto/tls/TlsSRPGroupVerifier;[B[B)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpGroup:Lorg/bouncycastle/crypto/params/SRP6GroupParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpServer:Lorg/bouncycastle/crypto/agreement/srp/SRP6Server;

    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpPeerCredentials:Ljava/math/BigInteger;

    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpVerifier:Ljava/math/BigInteger;

    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpSalt:[B

    iput-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->serverCredentials:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;
...
.method public constructor <init>(ILjava/util/Vector;[BLorg/bouncycastle/crypto/tls/TlsSRPLoginParameters;)V
    ...
    new-instance v0, Lorg/bouncycastle/crypto/agreement/srp/SRP6Server;

    invoke-direct {v0}, Lorg/bouncycastle/crypto/agreement/srp/SRP6Server;-><init>()V
...
.method public generateClientKeyExchange(Ljava/io/OutputStream;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->identity:[B

    invoke-static {v1}, Lorg/bouncycastle/util/Arrays;->clone([B)[B

    move-result-object v1

    iput-object v1, v0, Lorg/bouncycastle/crypto/tls/SecurityParameters;->srpIdentity:[B
...
.method public processClientKeyExchange(Ljava/io/InputStream;)V
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->validatePublicValue(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public processServerKeyExchange(Ljava/io/InputStream;)V
    ...
    :goto_0
    invoke-static {v0}, Lorg/bouncycastle/crypto/tls/ServerSRPParams;->parse(Ljava/io/InputStream;)Lorg/bouncycastle/crypto/tls/ServerSRPParams;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->tlsSigner:Lorg/bouncycastle/crypto/tls/TlsSigner;
    ...
    invoke-virtual {p0, v4, v5, v2}, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->initVerifyer(Lorg/bouncycastle/crypto/tls/TlsSigner;Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/tls/SecurityParameters;)Lorg/bouncycastle/crypto/Signer;
    ...
    :cond_0
    new-instance v1, Lorg/bouncycastle/crypto/params/SRP6GroupParameters;

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ServerSRPParams;->getN()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ServerSRPParams;->getG()Ljava/math/BigInteger;

    move-result-object v3

    invoke-direct {v1, v2, v3}, Lorg/bouncycastle/crypto/params/SRP6GroupParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpGroup:Lorg/bouncycastle/crypto/params/SRP6GroupParameters;

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->groupVerifier:Lorg/bouncycastle/crypto/tls/TlsSRPGroupVerifier;

    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpGroup:Lorg/bouncycastle/crypto/params/SRP6GroupParameters;

    invoke-interface {v1, v2}, Lorg/bouncycastle/crypto/tls/TlsSRPGroupVerifier;->accept(Lorg/bouncycastle/crypto/params/SRP6GroupParameters;)Z
    ...
    :cond_1
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ServerSRPParams;->getS()[B

    move-result-object v1

    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpSalt:[B

    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsSRPKeyExchange;->srpGroup:Lorg/bouncycastle/crypto/params/SRP6GroupParameters;

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/SRP6GroupParameters;->getN()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ServerSRPParams;->getB()Ljava/math/BigInteger;

    move-result-object v0

    invoke-static {v1, v0}, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->validatePublicValue(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lorg/bouncycastle/crypto/agreement/srp/SRP6Client;->init(Lorg/bouncycastle/crypto/params/SRP6GroupParameters;Lorg/bouncycastle/crypto/Digest;Ljava/security/SecureRandom;)V
