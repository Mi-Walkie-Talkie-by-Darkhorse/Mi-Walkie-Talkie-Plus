...
# virtual methods
.method checkTerminated(ZZZLd/b/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Ld/b/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 11
    :cond_2
    invoke-interface {p4}, Ld/b/c;->onComplete()V
...
.method drain()V
    ...
    .line 4
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Ld/b/c;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Ld/b/c;)V
...
.method drainFused(Ld/b/c;)V
    ...
    .line 11
    :cond_2
    invoke-interface {p1, v4}, Ld/b/c;->onNext(Ljava/lang/Object;)V
...
.method drainRegular(Ld/b/c;)V
    ...
    .line 6
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLd/b/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 7
    invoke-interface {v5, v8}, Ld/b/c;->onNext(Ljava/lang/Object;)V
