...
# direct methods
.method constructor <init>(Ld/b/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Ld/b/c;
...
.method public onSubscribe(Ld/b/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ld/b/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ld/b/d;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Ld/b/c;
...
.method public run()V
    ...
    .line 3
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Ld/b/c;
    ...
    .line 11
    invoke-interface {v3, v15}, Ld/b/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 16
    :cond_6
    invoke-interface {v3, v15}, Ld/b/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 17
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ld/b/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Ld/b/d;->request(J)V
