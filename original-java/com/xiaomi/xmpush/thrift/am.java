...
public class am implements Serializable, Cloneable, org.apache.thrift.a<am, a> {
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b(SocialConstants.TYPE_REQUEST, 2, new g(12, al.class)));
    ...
    public boolean a(am amVar) {
        ...
        boolean b2 = b();
        boolean b3 = amVar.b();
        if ((b2 || b3) && (!b2 || !b3 || !this.b.a(amVar.b))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = amVar.c();
        if ((c2 || c3) && (!c2 || !c3 || !this.c.equals(amVar.c))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = amVar.d();
        if ((d2 || d3) && (!d2 || !d3 || !this.d.equals(amVar.d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = amVar.e();
        if ((e2 || e3) && (!e2 || !e3 || !this.e.a(amVar.e))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = amVar.f();
        if ((f2 || f3) && (!f2 || !f3 || this.f != amVar.f)) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = amVar.g();
        if ((g2 || g3) && (!g2 || !g3 || !this.g.equals(amVar.g))) {
            return false;
        }
        boolean i2 = i();
        boolean i3 = amVar.i();
        if ((i2 || i3) && (!i2 || !i3 || !this.h.equals(amVar.h))) {
            return false;
        }
        boolean j2 = j();
        boolean j3 = amVar.j();
        if ((j2 || j3) && (!j2 || !j3 || !this.i.equals(amVar.i))) {
            return false;
        }
        boolean l2 = l();
        boolean l3 = amVar.l();
        return (!l2 && !l3) || (l2 && l3 && this.j.equals(amVar.j));
    }
    ...
    public int compareTo(am amVar) {
        ...
        if (a()) {
            int a2 = org.apache.thrift.b.a(this.a, amVar.a);
            if (a2 != 0) {
                return a2;
            }
        }
        ...
        if (b()) {
            int a3 = org.apache.thrift.b.a((Comparable) this.b, (Comparable) amVar.b);
            if (a3 != 0) {
                return a3;
            }
        }
        ...
        if (c()) {
            int a4 = org.apache.thrift.b.a(this.c, amVar.c);
            if (a4 != 0) {
                return a4;
            }
        }
        ...
        if (d()) {
            int a5 = org.apache.thrift.b.a(this.d, amVar.d);
            if (a5 != 0) {
                return a5;
            }
        }
        ...
        if (e()) {
            int a6 = org.apache.thrift.b.a((Comparable) this.e, (Comparable) amVar.e);
            if (a6 != 0) {
                return a6;
            }
        }
        ...
        if (f()) {
            int a7 = org.apache.thrift.b.a(this.f, amVar.f);
            if (a7 != 0) {
                return a7;
            }
        }
        ...
        if (g()) {
            int a8 = org.apache.thrift.b.a(this.g, amVar.g);
            if (a8 != 0) {
                return a8;
            }
        }
        int compareTo8 = Boolean.valueOf(i()).compareTo(Boolean.valueOf(amVar.i()));
        if (compareTo8 != 0) {
            return compareTo8;
        }
        if (i()) {
            int a9 = org.apache.thrift.b.a(this.h, amVar.h);
            if (a9 != 0) {
                return a9;
            }
        }
        int compareTo9 = Boolean.valueOf(j()).compareTo(Boolean.valueOf(amVar.j()));
        if (compareTo9 != 0) {
            return compareTo9;
        }
        if (j()) {
            int a10 = org.apache.thrift.b.a(this.i, amVar.i);
            if (a10 != 0) {
                return a10;
            }
        }
        int compareTo10 = Boolean.valueOf(l()).compareTo(Boolean.valueOf(amVar.l()));
        if (compareTo10 != 0) {
            return compareTo10;
        }
        if (l()) {
            int a11 = org.apache.thrift.b.a(this.j, amVar.j);
            if (a11 != 0) {
                return a11;
            }
        }
