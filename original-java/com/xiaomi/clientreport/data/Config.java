...
public class Config {
    ...
    private Config(Context context, Builder builder) {
        ...
        this.mAESKey = !TextUtils.isEmpty(builder.mAESKey) ? builder.mAESKey : C6027bs.m3603a(context);
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(C6027bs.m3603a(context)).setMaxFileLength(1048576L).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400L).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400L).build(context);
    }
