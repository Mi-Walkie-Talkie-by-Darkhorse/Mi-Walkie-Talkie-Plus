...
public class PutObjectResult {
    ...
    public String getRelativePreSignedUri() throws URISyntaxException {
        return new URI(null, null, null, -1, "/" + this.bucketName + "/" + this.objectName, "GalaxyAccessKeyId=" + this.accessKeyId + "&Expires=" + this.expires + "&Signature=" + this.signature, null).toString();
    }
