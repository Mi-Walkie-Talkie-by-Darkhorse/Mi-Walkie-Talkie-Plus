...
public class OAuthCredential implements GalaxyFDSCredential {
    ...
    private StorageAccessToken getStorageAccessToken(String str, String str2, String str3, String str4, String str5, String str6, String str7) throws GalaxyFDSClientException {
        try {
            ...
            HttpGet httpGet = new HttpGet(str + "/?" + STORAGE_ACCESS_TOKEN + ContainerUtils.FIELD_DELIMITER + APP_ID + ContainerUtils.KEY_VALUE_DELIMITER + str2 + ContainerUtils.FIELD_DELIMITER + OAUTH_APPID + ContainerUtils.KEY_VALUE_DELIMITER + str3 + ContainerUtils.FIELD_DELIMITER + OAUTH_ACCESS_TOKEN + ContainerUtils.KEY_VALUE_DELIMITER + str4 + ContainerUtils.FIELD_DELIMITER + OAUTH_PROVIDER + ContainerUtils.KEY_VALUE_DELIMITER + str5 + ContainerUtils.FIELD_DELIMITER + OAUTH_MAC_ALGORITHM + ContainerUtils.KEY_VALUE_DELIMITER + str7 + ContainerUtils.FIELD_DELIMITER + OAUTH_MAC_KEY + ContainerUtils.KEY_VALUE_DELIMITER + str6);
