...
public enum EnumC6158fm {
    ...
    BATCH_TCP_CONN_SUCCESS(XiaomiOAuthConstants.SCOPE_ACCESS_MI_ROUTER),
    BATCH_TCP_CONN_FAIL(1001),
    CHANNEL_STATS_COUNTER(WebIndicator.MAX_UNIFORM_SPEED_DURATION),
    ...
    /* renamed from: a */
    public static EnumC6158fm m2917a(int i) {
        if (i != 30501) {
            if (i != 30502) {
                switch (i) {
                    case 1:
