...
public final class SharkProtos {
    ...
    /* renamed from: a */
    private static final Descriptors.Descriptor f14643a;

    /* renamed from: b */
    private static GeneratedMessage.FieldAccessorTable f14644b;

    /* renamed from: c */
    private static final Descriptors.Descriptor f14645c;

    /* renamed from: d */
    private static GeneratedMessage.FieldAccessorTable f14646d;

    /* renamed from: e */
    private static final Descriptors.Descriptor f14647e;

    /* renamed from: f */
    private static GeneratedMessage.FieldAccessorTable f14648f;

    /* renamed from: g */
    private static final Descriptors.Descriptor f14649g;

    /* renamed from: h */
    private static GeneratedMessage.FieldAccessorTable f14650h;

    /* renamed from: i */
    private static final Descriptors.Descriptor f14651i;

    /* renamed from: j */
    private static GeneratedMessage.FieldAccessorTable f14652j;

    /* renamed from: k */
    private static final Descriptors.Descriptor f14653k;

    /* renamed from: l */
    private static GeneratedMessage.FieldAccessorTable f14654l;

    /* renamed from: m */
    private static final Descriptors.Descriptor f14655m;

    /* renamed from: n */
    private static GeneratedMessage.FieldAccessorTable f14656n;

    /* renamed from: o */
    private static final Descriptors.Descriptor f14657o;

    /* renamed from: p */
    private static GeneratedMessage.FieldAccessorTable f14658p;

    /* renamed from: q */
    private static final Descriptors.Descriptor f14659q;

    /* renamed from: r */
    private static GeneratedMessage.FieldAccessorTable f14660r;

    /* renamed from: s */
    private static final Descriptors.Descriptor f14661s;

    /* renamed from: t */
    private static GeneratedMessage.FieldAccessorTable f14662t;

    /* renamed from: u */
    private static Descriptors.FileDescriptor f14663u;
    ...
    public enum SHARK_CONNCODE implements ProtocolMessageEnum {
        ...
        private static Internal.EnumLiteMap<SHARK_CONNCODE> internalValueMap = new C4302a();
        private static final SHARK_CONNCODE[] VALUES = values();

        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_CONNCODE$a */
        /* loaded from: classes2.dex */
        class C4302a implements Internal.EnumLiteMap<SHARK_CONNCODE> {
            C4302a() {
            }
        ...
        public static final Descriptors.EnumDescriptor getDescriptor() {
            return SharkProtos.m10729v().getEnumTypes().get(0);
        }
    ...
    public static final class SHARK_ChannelInfo extends GeneratedMessage implements SHARK_ChannelInfoOrBuilder {
        ...
        public static Parser<SHARK_ChannelInfo> PARSER = new C4304a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_ChannelInfoOrBuilder {
            ...
            /* synthetic */ Builder(GeneratedMessage.BuilderParent builderParent, C4326a c4326a) {
                this(builderParent);
            }
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14646d.ensureFieldAccessorsInitialized(SHARK_ChannelInfo.class, Builder.class);
            }
            ...
            public Builder setChElim(SHARK_SWITCH shark_switch) {
                Objects.requireNonNull(shark_switch);
            ...
            public Builder setChType(SHARK_CHTYPE shark_chtype) {
                Objects.requireNonNull(shark_chtype);
                this.bitField0_ |= 2;
        ...
        public enum SHARK_CHTYPE implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_CHTYPE> internalValueMap = new C4303a();
            private static final SHARK_CHTYPE[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelInfo$SHARK_CHTYPE$a */
            /* loaded from: classes2.dex */
            class C4303a implements Internal.EnumLiteMap<SHARK_CHTYPE> {
                C4303a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelInfo$a */
        /* loaded from: classes2.dex */
        class C4304a extends AbstractParser<SHARK_ChannelInfo> {
            C4304a() {
            }
        ...
        /* synthetic */ SHARK_ChannelInfo(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_ChannelInfoOperate extends GeneratedMessage implements SHARK_ChannelInfoOperateOrBuilder {
        ...
        public static Parser<SHARK_ChannelInfoOperate> PARSER = new C4307a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_ChannelInfoOperateOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14652j.ensureFieldAccessorsInitialized(SHARK_ChannelInfoOperate.class, Builder.class);
            }
            ...
            public Builder setCh(SHARK_ChannelInfo sHARK_ChannelInfo) {
                SingleFieldBuilder<SHARK_ChannelInfo, SHARK_ChannelInfo.Builder, SHARK_ChannelInfoOrBuilder> singleFieldBuilder = this.chBuilder_;
                if (singleFieldBuilder == null) {
                    Objects.requireNonNull(sHARK_ChannelInfo);
                    this.ch_ = sHARK_ChannelInfo;
                    onChanged();
                } else {
            ...
            public Builder setOption(SHARK_CHOPTION shark_choption) {
                Objects.requireNonNull(shark_choption);
                this.bitField0_ |= 4;
            ...
            public Builder setResult(SHARK_CH_UERR shark_ch_uerr) {
                Objects.requireNonNull(shark_ch_uerr);
                this.bitField0_ |= 2;
        ...
        public enum SHARK_CHOPTION implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_CHOPTION> internalValueMap = new C4305a();
            private static final SHARK_CHOPTION[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelInfoOperate$SHARK_CHOPTION$a */
            /* loaded from: classes2.dex */
            class C4305a implements Internal.EnumLiteMap<SHARK_CHOPTION> {
                C4305a() {
                }
        ...
        public enum SHARK_CH_UERR implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_CH_UERR> internalValueMap = new C4306a();
            private static final SHARK_CH_UERR[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelInfoOperate$SHARK_CH_UERR$a */
            /* loaded from: classes2.dex */
            class C4306a implements Internal.EnumLiteMap<SHARK_CH_UERR> {
                C4306a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelInfoOperate$a */
        /* loaded from: classes2.dex */
        class C4307a extends AbstractParser<SHARK_ChannelInfoOperate> {
            C4307a() {
            }
        ...
        /* synthetic */ SHARK_ChannelInfoOperate(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_ChannelStateOperate extends GeneratedMessage implements SHARK_ChannelStateOperateOrBuilder {
        ...
        public static final int OPTION_FIELD_NUMBER = 3;
        public static Parser<SHARK_ChannelStateOperate> PARSER = new C4311a();
        public static final int RESULT_FIELD_NUMBER = 2;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_ChannelStateOperateOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14650h.ensureFieldAccessorsInitialized(SHARK_ChannelStateOperate.class, Builder.class);
            }
            ...
            public Builder setDeviceMode(SHARK_MODE shark_mode) {
                Objects.requireNonNull(shark_mode);
                this.bitField0_ |= 8;
            ...
            public Builder setOption(SHARK_STOPTION shark_stoption) {
                Objects.requireNonNull(shark_stoption);
                this.bitField0_ |= 4;
            ...
            public Builder setResult(SHARK_ST_UERR shark_st_uerr) {
                Objects.requireNonNull(shark_st_uerr);
                this.bitField0_ |= 2;
        ...
        public enum SHARK_MODE implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_MODE> internalValueMap = new C4308a();
            private static final SHARK_MODE[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelStateOperate$SHARK_MODE$a */
            /* loaded from: classes2.dex */
            class C4308a implements Internal.EnumLiteMap<SHARK_MODE> {
                C4308a() {
                }
        ...
        public enum SHARK_STOPTION implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_STOPTION> internalValueMap = new C4309a();
            private static final SHARK_STOPTION[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelStateOperate$SHARK_STOPTION$a */
            /* loaded from: classes2.dex */
            class C4309a implements Internal.EnumLiteMap<SHARK_STOPTION> {
                C4309a() {
                }
        ...
        public enum SHARK_ST_UERR implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_ST_UERR> internalValueMap = new C4310a();
            private static final SHARK_ST_UERR[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelStateOperate$SHARK_ST_UERR$a */
            /* loaded from: classes2.dex */
            class C4310a implements Internal.EnumLiteMap<SHARK_ST_UERR> {
                C4310a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_ChannelStateOperate$a */
        /* loaded from: classes2.dex */
        class C4311a extends AbstractParser<SHARK_ChannelStateOperate> {
            C4311a() {
            }
        ...
        /* synthetic */ SHARK_ChannelStateOperate(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_Connect extends GeneratedMessage implements SHARK_ConnectOrBuilder {
        ...
        public static Parser<SHARK_Connect> PARSER = new C4314a();
        public static final int VERSION_FIELD_NUMBER = 1;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_ConnectOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14644b.ensureFieldAccessorsInitialized(SHARK_Connect.class, Builder.class);
            }

            public Builder setAppMode(SHARK_APPTYPE shark_apptype) {
                Objects.requireNonNull(shark_apptype);
                this.bitField0_ |= 16;
            ...
            public Builder setConnCode(SHARK_CONNCODE shark_conncode) {
                Objects.requireNonNull(shark_conncode);
                this.bitField0_ |= 2;
            ...
            public Builder setLanguage(SHARK_LANGUAGETYPE shark_languagetype) {
                Objects.requireNonNull(shark_languagetype);
                this.bitField0_ |= 32;
        ...
        public enum SHARK_APPTYPE implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_APPTYPE> internalValueMap = new C4312a();
            private static final SHARK_APPTYPE[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_Connect$SHARK_APPTYPE$a */
            /* loaded from: classes2.dex */
            class C4312a implements Internal.EnumLiteMap<SHARK_APPTYPE> {
                C4312a() {
                }
        ...
        public enum SHARK_LANGUAGETYPE implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_LANGUAGETYPE> internalValueMap = new C4313a();
            private static final SHARK_LANGUAGETYPE[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_Connect$SHARK_LANGUAGETYPE$a */
            /* loaded from: classes2.dex */
            class C4313a implements Internal.EnumLiteMap<SHARK_LANGUAGETYPE> {
                C4313a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_Connect$a */
        /* loaded from: classes2.dex */
        class C4314a extends AbstractParser<SHARK_Connect> {
            C4314a() {
            }
        ...
        /* synthetic */ SHARK_Connect(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_DeviceParam extends GeneratedMessage implements SHARK_DeviceParamOrBuilder {
        ...
        public static Parser<SHARK_DeviceParam> PARSER = new C4316a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_DeviceParamOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14648f.ensureFieldAccessorsInitialized(SHARK_DeviceParam.class, Builder.class);
            }
            ...
            public Builder setResult(SHARK_DEV_UERR shark_dev_uerr) {
                Objects.requireNonNull(shark_dev_uerr);
                this.bitField0_ |= 2;
        ...
        public enum SHARK_DEV_UERR implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_DEV_UERR> internalValueMap = new C4315a();
            private static final SHARK_DEV_UERR[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_DeviceParam$SHARK_DEV_UERR$a */
            /* loaded from: classes2.dex */
            class C4315a implements Internal.EnumLiteMap<SHARK_DEV_UERR> {
                C4315a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_DeviceParam$a */
        /* loaded from: classes2.dex */
        class C4316a extends AbstractParser<SHARK_DeviceParam> {
            C4316a() {
            }
        ...
        /* synthetic */ SHARK_DeviceParam(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_LocationInfo extends GeneratedMessage implements SHARK_LocationInfoOrBuilder {
        ...
        public static Parser<SHARK_LocationInfo> PARSER = new C4317a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_LocationInfoOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14654l.ensureFieldAccessorsInitialized(SHARK_LocationInfo.class, Builder.class);
            }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_LocationInfo$a */
        /* loaded from: classes2.dex */
        class C4317a extends AbstractParser<SHARK_LocationInfo> {
            C4317a() {
            }
        ...
        /* synthetic */ SHARK_LocationInfo(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public enum SHARK_SWITCH implements ProtocolMessageEnum {
        ...
        private final int index;
        private final int value;
        private static Internal.EnumLiteMap<SHARK_SWITCH> internalValueMap = new C4318a();
        private static final SHARK_SWITCH[] VALUES = values();

        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_SWITCH$a */
        /* loaded from: classes2.dex */
        class C4318a implements Internal.EnumLiteMap<SHARK_SWITCH> {
            C4318a() {
            }
        ...
        public static final Descriptors.EnumDescriptor getDescriptor() {
            return SharkProtos.m10729v().getEnumTypes().get(1);
        }
    ...
    public static final class SHARK_UpGradeFilePack extends GeneratedMessage implements SHARK_UpGradeFilePackOrBuilder {
        ...
        public static Parser<SHARK_UpGradeFilePack> PARSER = new C4319a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_UpGradeFilePackOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14660r.ensureFieldAccessorsInitialized(SHARK_UpGradeFilePack.class, Builder.class);
            }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFilePack$a */
        /* loaded from: classes2.dex */
        class C4319a extends AbstractParser<SHARK_UpGradeFilePack> {
            C4319a() {
            }
        ...
        /* synthetic */ SHARK_UpGradeFilePack(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_UpGradeFileRequest extends GeneratedMessage implements SHARK_UpGradeFileRequestOrBuilder {
        ...
        public static Parser<SHARK_UpGradeFileRequest> PARSER = new C4322a();
        public static final int VERSION_FIELD_NUMBER = 1;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_UpGradeFileRequestOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14656n.ensureFieldAccessorsInitialized(SHARK_UpGradeFileRequest.class, Builder.class);
            }

            public Builder setFCmd(SHARK_FILECMD shark_filecmd) {
                Objects.requireNonNull(shark_filecmd);
                this.bitField0_ |= 2;
            ...
            public Builder setFType(SHARK_FILETYPE shark_filetype) {
                Objects.requireNonNull(shark_filetype);
                this.bitField0_ |= 4;
        ...
        public enum SHARK_FILECMD implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_FILECMD> internalValueMap = new C4320a();
            private static final SHARK_FILECMD[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFileRequest$SHARK_FILECMD$a */
            /* loaded from: classes2.dex */
            class C4320a implements Internal.EnumLiteMap<SHARK_FILECMD> {
                C4320a() {
                }
        ...
        public enum SHARK_FILETYPE implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_FILETYPE> internalValueMap = new C4321a();
            private static final SHARK_FILETYPE[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFileRequest$SHARK_FILETYPE$a */
            /* loaded from: classes2.dex */
            class C4321a implements Internal.EnumLiteMap<SHARK_FILETYPE> {
                C4321a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFileRequest$a */
        /* loaded from: classes2.dex */
        class C4322a extends AbstractParser<SHARK_UpGradeFileRequest> {
            C4322a() {
            }
        ...
        /* synthetic */ SHARK_UpGradeFileRequest(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_UpGradeFileResponse extends GeneratedMessage implements SHARK_UpGradeFileResponseOrBuilder {
        ...
        public static Parser<SHARK_UpGradeFileResponse> PARSER = new C4324a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_UpGradeFileResponseOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14658p.ensureFieldAccessorsInitialized(SHARK_UpGradeFileResponse.class, Builder.class);
            }
            ...
            public Builder setResult(SHARK_UP_UERR shark_up_uerr) {
                Objects.requireNonNull(shark_up_uerr);
                this.bitField0_ |= 1;
        ...
        public enum SHARK_UP_UERR implements ProtocolMessageEnum {
            ...
            private final int index;
            private final int value;
            private static Internal.EnumLiteMap<SHARK_UP_UERR> internalValueMap = new C4323a();
            private static final SHARK_UP_UERR[] VALUES = values();

            /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFileResponse$SHARK_UP_UERR$a */
            /* loaded from: classes2.dex */
            class C4323a implements Internal.EnumLiteMap<SHARK_UP_UERR> {
                C4323a() {
                }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UpGradeFileResponse$a */
        /* loaded from: classes2.dex */
        class C4324a extends AbstractParser<SHARK_UpGradeFileResponse> {
            C4324a() {
            }
        ...
        /* synthetic */ SHARK_UpGradeFileResponse(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    public static final class SHARK_UserActionStatistics extends GeneratedMessage implements SHARK_UserActionStatisticsOrBuilder {
        ...
        public static Parser<SHARK_UserActionStatistics> PARSER = new C4325a();
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SHARK_UserActionStatisticsOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SharkProtos.f14662t.ensureFieldAccessorsInitialized(SHARK_UserActionStatistics.class, Builder.class);
            }
        ...
        /* renamed from: com.ifengyu.intercom.protos.SharkProtos$SHARK_UserActionStatistics$a */
        /* loaded from: classes2.dex */
        class C4325a extends AbstractParser<SHARK_UserActionStatistics> {
            C4325a() {
            }
        ...
        /* synthetic */ SHARK_UserActionStatistics(GeneratedMessage.Builder builder, C4326a c4326a) {
            this(builder);
        }
    ...
    /* renamed from: com.ifengyu.intercom.protos.SharkProtos$a */
    /* loaded from: classes2.dex */
    public class C4326a implements Descriptors.FileDescriptor.InternalDescriptorAssigner {
        C4326a() {
        }

        @Override // com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner
        public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor fileDescriptor) {
            Descriptors.FileDescriptor unused = SharkProtos.f14663u = fileDescriptor;
            return null;
        }
    }

    static {
        Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u000bshark.proto\u0012\u0006protos\"æ\u0002\n\rSHARK_Connect\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u0012(\n\bconnCode\u0018\u0002 \u0002(\u000e2\u0016.protos.SHARK_CONNCODE\u0012\u0010\n\bdeviceId\u0018\u0003 \u0001(\r\u0012\u0012\n\ndeviceType\u0018\u0004 \u0001(\r\u00124\n\u0007appMode\u0018\u0005 \u0001(\u000e2#.protos.SHARK_Connect.SHARK_APPTYPE\u0012:\n\blanguage\u0018\u0006 \u0001(\u000e2(.protos.SHARK_Connect.SHARK_LANGUAGETYPE\u0012\r\n\u0005btmac\u0018\u0007 \u0001(\f\"7\n\rSHARK_APPTYPE\u0012\u0011\n\rSHARK_OWN_APP\u0010\u0000\u0012\u0013\n\u000fSHARK_MIJIA_APP\u0010\u0001\":\n\u0012SHARK_LANGUAGETYPE\u0012\u0011\n\rSHARK_CHINESE\u0010\u0000\u0012\u0011\n\rSHARK_ENGLISH\u0010\u0001\"\u0091\u0003\n\u0011SHARK_Channel", "Info\u0012\r\n\u0005ch_no\u0018\u0001 \u0001(\r\u00127\n\u0007ch_type\u0018\u0002 \u0001(\u000e2&.protos.SHARK_ChannelInfo.SHARK_CHTYPE\u0012\u0012\n\nch_txPower\u0018\u0003 \u0001(\r\u0012\u0011\n\tch_rxFreq\u0018\u0004 \u0001(\r\u0012\u0011\n\tch_txFreq\u0018\u0005 \u0001(\r\u0012\u000f\n\u0007ch_name\u0018\u0006 \u0001(\f\u0012\r\n\u0005ch_sq\u0018\u0007 \u0001(\r\u0012\u000e\n\u0006ch_vox\u0018\b \u0001(\r\u0012\u0010\n\bch_rxCss\u0018\t \u0001(\r\u0012\u0010\n\bch_txCss\u0018\n \u0001(\r\u0012%\n\u0007ch_elim\u0018\u000b \u0001(\u000e2\u0014.protos.SHARK_SWITCH\u0012\u000f\n\u0007ch_band\u0018\f \u0001(\r\u0012'\n\tch_polite\u0018\r \u0001(\u000e2\u0014.protos.SHARK_SWITCH\"E\n\fSHARK_CHTYPE\u0012\u0010\n\fSHARK_PUBLIC\u0010\u0000\u0012\u0010\n\fSHARK_REMOTE\u0010\u0001\u0012\u0011\n\rSHARK_USERDEF\u0010\u0002\"ú\u0004\n\u0011SHARK_Dev", "iceParam\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u00128\n\u0006result\u0018\u0002 \u0001(\u000e2(.protos.SHARK_DeviceParam.SHARK_DEV_UERR\u0012)\n\u000bfullInquiry\u0018\u0003 \u0001(\u000e2\u0014.protos.SHARK_SWITCH\u0012\r\n\u0005verHw\u0018\u0004 \u0001(\r\u0012\u000f\n\u0007verSoft\u0018\u0005 \u0001(\r\u0012\u0012\n\ndeviceName\u0018\u0006 \u0001(\f\u0012\u000f\n\u0007bleName\u0018\u0007 \u0001(\f\u0012\u000e\n\u0006charge\u0018\b \u0001(\r\u0012\u0010\n\bactivate\u0018\t \u0001(\r\u0012&\n\bshareLoc\u0018\n \u0001(\u000e2\u0014.protos.SHARK_SWITCH\u0012\u000f\n\u0007btAudio\u0018\u000b \u0001(\r\u0012%\n\u0002ch\u0018\f \u0001(\u000b2\u0019.protos.SHARK_ChannelInfo\u0012(\n\nvoiceAlert\u0018\r \u0001(\u000e2\u0014.protos.SHARK_SWITCH\u0012)\n\u000bisAllPublic\u0018\u000e \u0001(\u000e2\u0014.protos.SH", "ARK_SWITCH\u0012\u0012\n\npwsaveMode\u0018\u000f \u0001(\r\u0012\u0011\n\ttimeStamp\u0018\u001e \u0001(\r\u0012)\n\u000btimeDisplay\u0018\u001f \u0001(\u000e2\u0014.protos.SHARK_SWITCH\"\u0080\u0001\n\u000eSHARK_DEV_UERR\u0012\u0018\n\u0014SHARK_PARAM_QUERY_OK\u0010\u0001\u0012\u001b\n\u0017SHARK_PARAM_QUERY_ERROR\u0010\u0002\u0012\u0019\n\u0015SHARK_PARAM_UPDATE_OK\u0010\u0003\u0012\u001c\n\u0018SHARK_PARAM_UPDATE_ERROR\u0010\u0004\"\u0098\u0005\n\u0019SHARK_ChannelStateOperate\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u0012?\n\u0006result\u0018\u0002 \u0001(\u000e2/.protos.SHARK_ChannelStateOperate.SHARK_ST_UERR\u0012@\n\u0006option\u0018\u0003 \u0001(\u000e20.protos.SHARK_ChannelStateOperate.SHARK_STOPTIO", "N\u0012@\n\ndeviceMode\u0018\u0004 \u0001(\u000e2,.protos.SHARK_ChannelStateOperate.SHARK_MODE\u0012\u0011\n\tstateMode\u0018\u0005 \u0001(\r\u0012&\n\u0003ch1\u0018\u0006 \u0001(\u000b2\u0019.protos.SHARK_ChannelInfo\u0012&\n\u0003ch2\u0018\u0007 \u0001(\u000b2\u0019.protos.SHARK_ChannelInfo\u0012\u0013\n\u000bcurrentChId\u0018\b \u0001(\r\"^\n\rSHARK_ST_UERR\u0012\u000f\n\u000bSHARK_ST_OK\u0010\u0000\u0012\u0012\n\u000eSHARK_ST_ERROR\u0010\u0001\u0012\u0012\n\u000eSHARK_ST_EMPTY\u0010\u0002\u0012\u0014\n\u0010SHARK_ST_FORBIDE\u0010\u0003\"9\n\u000eSHARK_STOPTION\u0012\u0013\n\u000fSHARK_ST_UPDATE\u0010\u0000\u0012\u0012\n\u000eSHARK_ST_QUERY\u0010\u0001\"\u0091\u0001\n\nSHARK_MODE\u0012\u0015\n\u0011SHARK_MODE_NORMAL\u0010\u0000\u0012\u000f\n\u000bSHARK_SOS_T\u0010\u0001\u0012\u000f\n", "\u000bSHARK_SOS_R\u0010\u0002\u0012\u0011\n\rSHARK_SCAN_CH\u0010\u0003\u0012\u0013\n\u000fSHARK_SCAN_FREQ\u0010\u0004\u0012\u0010\n\fSHARK_TEAM_M\u0010\u0005\u0012\u0010\n\fSHARK_TEAM_S\u0010\u0006\"Ñ\u0003\n\u0018SHARK_ChannelInfoOperate\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u0012>\n\u0006result\u0018\u0002 \u0001(\u000e2..protos.SHARK_ChannelInfoOperate.SHARK_CH_UERR\u0012?\n\u0006option\u0018\u0003 \u0001(\u000e2/.protos.SHARK_ChannelInfoOperate.SHARK_CHOPTION\u0012%\n\u0002ch\u0018\u0004 \u0001(\u000b2\u0019.protos.SHARK_ChannelInfo\"\u0096\u0001\n\rSHARK_CH_UERR\u0012\u000f\n\u000bSHARK_CH_OK\u0010\u0000\u0012\u0012\n\u000eSHARK_CH_ERROR\u0010\u0001\u0012\u0012\n\u000eSHARK_CH_EMPTY\u0010\u0002\u0012\u0014\n\u0010SHARK_CH_FORBIDE\u0010", "\u0003\u0012\u001b\n\u0017SHARK_CH_QUERY_CONTINUE\u0010\u0004\u0012\u0019\n\u0015SHARK_CH_QUERY_FINISH\u0010\u0005\"c\n\u000eSHARK_CHOPTION\u0012\u0013\n\u000fSHARK_CH_INSERT\u0010\u0000\u0012\u0013\n\u000fSHARK_CH_DELETE\u0010\u0001\u0012\u0013\n\u000fSHARK_CH_MODIFY\u0010\u0002\u0012\u0012\n\u000eSHARK_CH_QUERY\u0010\u0003\"Ø\u0001\n\u0012SHARK_LocationInfo\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u0012%\n\u0007ctlsync\u0018\u0002 \u0001(\u000e2\u0014.protos.SHARK_SWITCH\u0012\u000e\n\u0006userId\u0018\u0003 \u0001(\r\u0012\u0010\n\buserName\u0018\u0004 \u0001(\f\u0012\u0010\n\buserFreq\u0018\u0005 \u0001(\r\u0012\u0011\n\tlongitude\u0018\u0006 \u0001(\u0011\u0012\u0010\n\blatitude\u0018\u0007 \u0001(\u0011\u0012\u0010\n\baltitude\u0018\b \u0001(\u0011\u0012\u0010\n\btimeSync\u0018\t \u0001(\r\u0012\r\n\u0005rxCss\u0018\n \u0001(\r\"à\u0002\n\u0018SHARK_UpGradeFileR", "equest\u0012\u000f\n\u0007version\u0018\u0001 \u0002(\r\u0012<\n\u0004fCmd\u0018\u0002 \u0002(\u000e2..protos.SHARK_UpGradeFileRequest.SHARK_FILECMD\u0012>\n\u0005fType\u0018\u0003 \u0002(\u000e2/.protos.SHARK_UpGradeFileRequest.SHARK_FILETYPE\u0012\r\n\u0005fSize\u0018\u0004 \u0001(\r\u0012\u000e\n\u0006fCrc32\u0018\u0005 \u0001(\r\"M\n\rSHARK_FILECMD\u0012\u0012\n\u000eSHARK_UP_START\u0010\u0001\u0012\u0013\n\u000fSHARK_UP_COMPLE\u0010\u0002\u0012\u0013\n\u000fSHARK_UP_REBOOT\u0010\u0003\"G\n\u000eSHARK_FILETYPE\u0012\u001a\n\u0016SHARK_APP_UPGRADE_FILE\u0010\u0001\u0012\u0019\n\u0015SHARK_MCU_UPLOAD_FILE\u0010\u0002\"Ï\u0001\n\u0019SHARK_UpGradeFileResponse\u0012?\n\u0006result\u0018\u0001 \u0002(\u000e2/.protos.SHARK_UpGrad", "eFileResponse.SHARK_UP_UERR\u0012\u000e\n\u0006offset\u0018\u0002 \u0001(\r\"a\n\rSHARK_UP_UERR\u0012\u0016\n\u0012SHARK_UP_RESULT_OK\u0010\u0001\u0012\u0019\n\u0015SHARK_UP_RESULT_ERROR\u0010\u0002\u0012\u001d\n\u0019SHARK_UP_RESULT_LOW_POWER\u0010\u0003\"B\n\u0015SHARK_UpGradeFilePack\u0012\u000e\n\u0006offset\u0018\u0001 \u0002(\r\u0012\f\n\u0004data\u0018\u0002 \u0002(\f\u0012\u000b\n\u0003xor\u0018\u0003 \u0002(\r\"²\u0002\n\u001aSHARK_UserActionStatistics\u0012\u000f\n\u0007powerOn\u0018\u0001 \u0001(\r\u0012\u0012\n\nazimuthMap\u0018\u0002 \u0001(\r\u0012\u000f\n\u0007fmRadio\u0018\u0003 \u0001(\r\u0012\u0011\n\tquickTeam\u0018\u0004 \u0001(\r\u0012\u0017\n\u000fbluetoothDevice\u0018\u0005 \u0001(\r\u0012\u0011\n\thandsFree\u0018\u0006 \u0001(\r\u0012\u0013\n\u000bchannelScan\u0018\u0007 \u0001(\r\u0012\u0012\n\ndoubleFreq\u0018\b \u0001(\r\u0012", "\u000f\n\u0007sosMode\u0018\t \u0001(\r\u0012\u0012\n\npowerLevel\u0018\n \u0001(\r\u0012\u0010\n\bbusyLock\u0018\u000b \u0001(\r\u0012\u0013\n\u000bsquelchTail\u0018\f \u0001(\r\u0012\u0012\n\nwideNarrow\u0018\r \u0001(\r\u0012\u0016\n\u000erestoreFactory\u0018\u000e \u0001(\r*ç\u0001\n\u000eSHARK_CONNCODE\u0012\u0014\n\u0010SHARK_DISCONNECT\u0010\u0000\u0012\u0011\n\rSHARK_CONNECT\u0010\u0001\u0012\u000f\n\u000bSHARK_ALLOW\u0010\u0004\u0012\u0010\n\fSHARK_REFUSE\u0010\u0005\u0012\u000e\n\nSHARK_WAIT\u0010\u0006\u0012\u0012\n\u000eSHARK_LOWPOWER\u0010\u0007\u0012\u0013\n\u000fSHARK_DIS_ALLOW\u0010\b\u0012\u0014\n\u0010SHARK_DIS_REFUSE\u0010\t\u0012\u0012\n\u000eSHARK_DIS_WAIT\u0010\n\u0012\u0016\n\u0012SHARK_DIS_LOWPOWER\u0010\u000b\u0012\u000e\n\nSHARK_BUSY\u0010\f*+\n\fSHARK_SWITCH\u0012\r\n\tSHARK_OFF\u0010\u0001\u0012\f\n\bSHARK_ON\u0010\u0002B,", "\n\u001bcom.ifengyu.intercom.protosB\u000bSharkProtosH\u0002"}, new Descriptors.FileDescriptor[0], new C4326a());
        Descriptors.Descriptor descriptor = m10729v().getMessageTypes().get(0);
        f14643a = descriptor;
        f14644b = new GeneratedMessage.FieldAccessorTable(descriptor, new String[]{"Version", "ConnCode", "DeviceId", "DeviceType", "AppMode", "Language", "Btmac"});
        Descriptors.Descriptor descriptor2 = m10729v().getMessageTypes().get(1);
        f14645c = descriptor2;
        f14646d = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"ChNo", "ChType", "ChTxPower", "ChRxFreq", "ChTxFreq", "ChName", "ChSq", "ChVox", "ChRxCss", "ChTxCss", "ChElim", "ChBand", "ChPolite"});
        Descriptors.Descriptor descriptor3 = m10729v().getMessageTypes().get(2);
        f14647e = descriptor3;
        f14648f = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"Version", "Result", "FullInquiry", "VerHw", "VerSoft", "DeviceName", "BleName", "Charge", "Activate", "ShareLoc", "BtAudio", "Ch", "VoiceAlert", "IsAllPublic", "PwsaveMode", "TimeStamp", "TimeDisplay"});
        Descriptors.Descriptor descriptor4 = m10729v().getMessageTypes().get(3);
        f14649g = descriptor4;
        f14650h = new GeneratedMessage.FieldAccessorTable(descriptor4, new String[]{"Version", "Result", "Option", "DeviceMode", "StateMode", "Ch1", "Ch2", "CurrentChId"});
        Descriptors.Descriptor descriptor5 = m10729v().getMessageTypes().get(4);
        f14651i = descriptor5;
        f14652j = new GeneratedMessage.FieldAccessorTable(descriptor5, new String[]{"Version", "Result", "Option", "Ch"});
        Descriptors.Descriptor descriptor6 = m10729v().getMessageTypes().get(5);
        f14653k = descriptor6;
        f14654l = new GeneratedMessage.FieldAccessorTable(descriptor6, new String[]{"Version", "Ctlsync", "UserId", "UserName", "UserFreq", "Longitude", "Latitude", "Altitude", "TimeSync", "RxCss"});
        Descriptors.Descriptor descriptor7 = m10729v().getMessageTypes().get(6);
        f14655m = descriptor7;
        f14656n = new GeneratedMessage.FieldAccessorTable(descriptor7, new String[]{"Version", "FCmd", "FType", "FSize", "FCrc32"});
        Descriptors.Descriptor descriptor8 = m10729v().getMessageTypes().get(7);
        f14657o = descriptor8;
        f14658p = new GeneratedMessage.FieldAccessorTable(descriptor8, new String[]{"Result", "Offset"});
        Descriptors.Descriptor descriptor9 = m10729v().getMessageTypes().get(8);
        f14659q = descriptor9;
        f14660r = new GeneratedMessage.FieldAccessorTable(descriptor9, new String[]{"Offset", "Data", "Xor"});
        Descriptors.Descriptor descriptor10 = m10729v().getMessageTypes().get(9);
        f14661s = descriptor10;
        f14662t = new GeneratedMessage.FieldAccessorTable(descriptor10, new String[]{"PowerOn", "AzimuthMap", "FmRadio", "QuickTeam", "BluetoothDevice", "HandsFree", "ChannelScan", "DoubleFreq", "SosMode", "PowerLevel", "BusyLock", "SquelchTail", "WideNarrow", "RestoreFactory"});
    }

    /* renamed from: v */
    public static Descriptors.FileDescriptor m10729v() {
        return f14663u;
    }
}
