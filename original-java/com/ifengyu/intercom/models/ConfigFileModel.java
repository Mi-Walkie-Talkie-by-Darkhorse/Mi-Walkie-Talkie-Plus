...
public class ConfigFileModel implements Parcelable {
    public static final Parcelable.Creator<ConfigFileModel> CREATOR = new Parcelable.Creator<ConfigFileModel>() { // from class: com.ifengyu.intercom.models.ConfigFileModel.1
    ...
    public void readFromParcel(Parcel parcel) {
        this.f14387id = (Long) parcel.readValue(Long.class.getClassLoader());
    ...
    public String toString() {
        return "ConfigFileModel{id=" + this.f14387id + ", name='" + this.name + "', from='" + this.from + "', createTime=" + this.createTime + ", updateTime=" + this.updateTime + ", mChannelModelList=" + this.mChannelModelList + '}';
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeValue(this.f14387id);
