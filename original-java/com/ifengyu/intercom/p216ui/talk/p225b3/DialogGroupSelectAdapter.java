...
/* renamed from: com.ifengyu.intercom.ui.talk.b3.e */
/* loaded from: classes2.dex */
public class DialogGroupSelectAdapter extends BaseQuickAdapter<ItemSelectAdapterEntity<Member>, BaseViewHolder> {

    /* renamed from: z */
    private final Fragment f15612z;

    public DialogGroupSelectAdapter(Fragment fragment, int i, @Nullable List<ItemSelectAdapterEntity<Member>> list) {
        super(i, list);
        this.f15612z = fragment;
    }
    ...
    public void mo9365w(@NonNull BaseViewHolder baseViewHolder, ItemSelectAdapterEntity<Member> itemSelectAdapterEntity) {
        ...
        ImageLoader.m8705f(this.f15612z, (ImageView) baseViewHolder.getView(R.id.iv_contact_avatar), data.getUser().getAvatar());
        baseViewHolder.setText(R.id.tv_contact_display_name, data.getUser().getName());
