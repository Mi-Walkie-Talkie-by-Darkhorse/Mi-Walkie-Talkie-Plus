...
public class SharkPresetChCssEditActivity_ViewBinding implements Unbinder {
    ...
    @CallSuper
    public void unbind() {
        SharkPresetChCssEditActivity sharkPresetChCssEditActivity = this.f13467a;
