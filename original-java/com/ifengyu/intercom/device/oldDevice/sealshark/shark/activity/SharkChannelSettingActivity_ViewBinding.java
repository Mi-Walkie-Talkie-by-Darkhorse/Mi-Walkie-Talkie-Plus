...
public class SharkChannelSettingActivity_ViewBinding implements Unbinder {
    ...
    @CallSuper
    public void unbind() {
        SharkChannelSettingActivity sharkChannelSettingActivity = this.f13457a;
