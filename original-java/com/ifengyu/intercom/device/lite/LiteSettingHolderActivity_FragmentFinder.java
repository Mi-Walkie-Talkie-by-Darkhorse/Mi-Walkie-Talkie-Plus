...
public class LiteSettingHolderActivity_FragmentFinder implements FirstFragmentFinder {
    ...
    public LiteSettingHolderActivity_FragmentFinder() {
        this.mClassToIdMap.put(LiteSettingFragment.class, 100);
        this.mIdToClassMap.put(100, LiteSettingFragment.class);
    }
