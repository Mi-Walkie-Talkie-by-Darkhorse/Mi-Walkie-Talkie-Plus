...
/* compiled from: SealUpdateInfoCallback */
public abstract class g extends b<McuUpdateInfoModel> {
    /* renamed from: a */
    public McuUpdateInfoModel b(Response response, int i) throws Exception {
        ...
        return (McuUpdateInfoModel) new Gson().fromJson(jSONObject.getJSONObject(Const.PARAM_DATA).getJSONObject("seal").toString(), McuUpdateInfoModel.class);
    }
}
