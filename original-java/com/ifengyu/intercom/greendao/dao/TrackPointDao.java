...
public class TrackPointDao extends AbstractDao<c, Long> {
    ...
    public TrackPointDao(DaoConfig daoConfig, b bVar) {
        super(daoConfig, bVar);
    }

    public static void a(Database database, boolean z) {
        String str = z ? "IF NOT EXISTS " : "";
        database.execSQL("CREATE TABLE " + str + "\"TRACK_POINT\" (\"_id\" INTEGER PRIMARY KEY ,\"TRACK_ID\" TEXT,\"LATITUDE\" INTEGER,\"LONGITUDE\" INTEGER,\"ALTITUDE\" INTEGER,\"CURRENT_DISTANCE\" INTEGER,\"CURRENT_TIME\" INTEGER,\"IS_PAUSED_POINT\" INTEGER NOT NULL );");
    }
