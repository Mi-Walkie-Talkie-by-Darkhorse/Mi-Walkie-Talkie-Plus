...
public class UserLocationDao extends AbstractDao<d, Long> {
    ...
    public UserLocationDao(DaoConfig daoConfig, b bVar) {
        super(daoConfig, bVar);
    }

    public static void a(Database database, boolean z) {
        String str = z ? "IF NOT EXISTS " : "";
        database.execSQL("CREATE TABLE " + str + "\"USER_LOCATION\" (\"_id\" INTEGER PRIMARY KEY ,\"USERID\" INTEGER,\"NAME\" TEXT,\"IMGURL\" TEXT,\"LONGITUDE\" INTEGER,\"LATITUDE\" INTEGER,\"ALTITUDE\" INTEGER,\"TIME\" INTEGER,\"FREQ\" INTEGER,\"RX_CSS\" INTEGER,\"FROM_DEV_TYPE\" INTEGER);");
        database.execSQL("CREATE UNIQUE INDEX " + str + "IDX_USER_LOCATION_USERID_DESC ON USER_LOCATION (\"USERID\" DESC);");
    }
