...
public class UserLocationDao extends a<d, Long> {
    ...
    public UserLocationDao(org.greenrobot.greendao.b.a aVar, b bVar) {
        super(aVar, bVar);
    }

    public static void a(org.greenrobot.greendao.a.a aVar, boolean z) {
        String str = z ? "IF NOT EXISTS " : "";
        aVar.a("CREATE TABLE " + str + "\"USER_LOCATION\" (\"_id\" INTEGER PRIMARY KEY ,\"USERID\" INTEGER,\"NAME\" TEXT,\"IMGURL\" TEXT,\"LONGITUDE\" INTEGER,\"LATITUDE\" INTEGER,\"ALTITUDE\" INTEGER,\"TIME\" INTEGER,\"FREQ\" INTEGER,\"RX_CSS\" INTEGER,\"FROM_DEV_TYPE\" INTEGER);");
        aVar.a("CREATE UNIQUE INDEX " + str + "IDX_USER_LOCATION_USERID_DESC ON USER_LOCATION (\"USERID\" DESC);");
    }

    public static void b(org.greenrobot.greendao.a.a aVar, boolean z) {
        aVar.a("DROP TABLE " + (z ? "IF EXISTS " : "") + "\"USER_LOCATION\"");
    }
