...
import com.ifengyu.intercom.ui.imui.ui.chat.session.fragment.SeeRoomMemberFragment;
...
public class SeeRoomMemberFragment_ViewBinding<T extends SeeRoomMemberFragment> implements Unbinder {
    protected T target;

    @UiThread
    public SeeRoomMemberFragment_ViewBinding(T t, View view) {
        this.target = t;
