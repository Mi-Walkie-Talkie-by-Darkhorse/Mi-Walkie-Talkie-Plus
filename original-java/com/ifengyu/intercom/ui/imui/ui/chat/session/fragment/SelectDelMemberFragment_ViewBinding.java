...
import com.ifengyu.intercom.ui.imui.ui.chat.session.fragment.SelectDelMemberFragment;
...
public class SelectDelMemberFragment_ViewBinding<T extends SelectDelMemberFragment> implements Unbinder {
    protected T target;

    @UiThread
    public SelectDelMemberFragment_ViewBinding(T t, View view) {
        this.target = t;
