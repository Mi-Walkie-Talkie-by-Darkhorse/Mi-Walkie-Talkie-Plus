...
public class PickerDialog extends b {
    public static final String[] a = ad.b((int) R.array.analog_tone);
    public static final String[] b = ad.b((int) R.array.digital_tone_normal);
    public static final String[] c = ad.b((int) R.array.digital_tone_inversion);
    ...
    public PickerDialog(BaseActivity baseActivity) {
        ...
        this.mNp1.setOnValueChangedListener(new b() {
            public void a(NumberPickerView numberPickerView, int i, int i2) {
                switch (i2) {
                    case 0:
                        PickerDialog.this.mNp2.a(PickerDialog.a);
                        return;
                    case 1:
                        PickerDialog.this.mNp2.a(PickerDialog.b);
                        return;
                    case 2:
                        PickerDialog.this.mNp2.a(PickerDialog.c);
                        return;
                    default:
                        return;
                }
    ...
    public PickerDialog a(@StringRes int i, a aVar) {
        this.mButtonNegative.setText(i);
        this.f = aVar;
        return this;
    }

    public PickerDialog b(@StringRes int i, a aVar) {
