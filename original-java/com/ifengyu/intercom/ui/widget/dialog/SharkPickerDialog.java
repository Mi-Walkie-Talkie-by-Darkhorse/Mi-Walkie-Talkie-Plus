...
public class SharkPickerDialog extends b {
    public static final String[] a = ad.b((int) R.array.shark_analog_tone);
    public static final String[] b = ad.b((int) R.array.shark_digital_tone_normal);
    public static final String[] c = ad.b((int) R.array.shark_digital_tone_inversion);
    ...
    public SharkPickerDialog(BaseActivity baseActivity) {
        super(baseActivity);
        ...
        this.mNp1.setOnValueChangedListener(new b() {
            public void a(NumberPickerView numberPickerView, int i, int i2) {
                switch (i2) {
                    case 0:
                        SharkPickerDialog.this.mNp2.a(SharkPickerDialog.a);
                        return;
                    case 1:
                        SharkPickerDialog.this.mNp2.a(SharkPickerDialog.b);
                        return;
                    case 2:
                        SharkPickerDialog.this.mNp2.a(SharkPickerDialog.c);
                        return;
                    default:
                        return;
                }
    ...
    public SharkPickerDialog a(@StringRes int i, a aVar) {
        this.mButtonNegative.setText(i);
        this.f = aVar;
        return this;
    }

    public SharkPickerDialog b(@StringRes int i, a aVar) {
