...
public class SealPresetChCssEditActivity_ViewBinding<T extends SealPresetChCssEditActivity> implements Unbinder {
    protected T a;

    @UiThread
    public SealPresetChCssEditActivity_ViewBinding(T t, View view) {
        this.a = t;
