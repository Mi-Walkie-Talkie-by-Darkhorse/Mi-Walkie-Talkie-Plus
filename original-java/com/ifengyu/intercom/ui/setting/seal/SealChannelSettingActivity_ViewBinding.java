...
public class SealChannelSettingActivity_ViewBinding<T extends SealChannelSettingActivity> implements Unbinder {
    protected T a;

    @UiThread
    public SealChannelSettingActivity_ViewBinding(T t, View view) {
        this.a = t;
