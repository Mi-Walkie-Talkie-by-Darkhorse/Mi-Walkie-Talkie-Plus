...
public class TextureMapView extends FrameLayout {
    ...
    public IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.a == null) {
            try {
                this.a = (IMapFragmentDelegate) ha.a(getContext(), ee.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", p.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            } catch (Throwable th) {
            }
            if (this.a == null) {
                this.a = new p(1);
