...
public class TextureMapFragment extends Fragment {
    ...
    public IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.b == null) {
            try {
                this.b = (IMapFragmentDelegate) ha.a(getActivity(), ee.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", p.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            } catch (Throwable th) {
            }
            if (this.b == null) {
                this.b = new p(1);
