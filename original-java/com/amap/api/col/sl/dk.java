...
public final class dk implements Closeable {
    ...
    public dk(InputStream inputStream, Charset charset) {
        this(inputStream, charset, 0);
    }

    private dk(InputStream inputStream, Charset charset, byte b2) {
        if (inputStream == null || charset == null) {
            throw new NullPointerException();
        } else if (!charset.equals(dl.a)) {
                ...
                if (i2 == this.e) {
                    AnonymousClass1 r1 = new ByteArrayOutputStream((this.e - this.d) + 80) {
                        public final String toString() {
                            try {
                                return new String(this.buf, 0, (this.count <= 0 || this.buf[this.count + -1] != 13) ? this.count : this.count - 1, dk.this.b.name());
