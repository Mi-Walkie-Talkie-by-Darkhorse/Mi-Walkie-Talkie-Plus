    ...
    private void encodeLowLevel(CharSequence charSequence, int i, int i2, int i3, BarcodeMatrix barcodeMatrix2) {
        ...
        for (int i7 = 0; i7 < i2; i7++) {
            ...
            if (i8 == 0) {
                ...
                i4 = ((i2 - 1) % 3) + ((i7 / 3) * 30) + (i3 * 3);
                i5 = ((i7 / 3) * 30) + ((i2 - 1) / 3);
            } else {
                i4 = (i - 1) + ((i7 / 3) * 30);
                i5 = ((i7 / 3) * 30) + (i3 * 3) + ((i2 - 1) % 3);
            }
            encodeChar(CODEWORD_TABLE[i8][i4], 17, barcodeMatrix2.getCurrentRow());
            for (int i9 = 0; i9 < i; i9++) {
                encodeChar(CODEWORD_TABLE[i8][charSequence.charAt(i6)], 17, barcodeMatrix2.getCurrentRow());
                i6++;
            }
            if (this.compact) {
