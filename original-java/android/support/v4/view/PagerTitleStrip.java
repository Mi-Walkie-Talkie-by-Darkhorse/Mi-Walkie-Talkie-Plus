...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int measuredHeight = this.mNextText.getMeasuredHeight() + i12;
        int max2 = Math.max(Math.max(this.mPrevText.getMeasuredHeight() + i10, this.mCurrText.getMeasuredHeight() + i11), measuredHeight);
