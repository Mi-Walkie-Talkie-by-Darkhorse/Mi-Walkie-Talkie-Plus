    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + Http.PROTOCOL_HOST_SPLITTER + Uri.encode(substring, "/")).build();
            } catch (IOException e) {
