    ...
    public void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if ((metaState & 5) == 0 && numericShortcut != 0 && ((numericShortcut == keyData.meta[0] || numericShortcut == keyData.meta[2] || (isQwertyMode && numericShortcut == 8 && i == 67)) && menuItemImpl.isEnabled())) {
