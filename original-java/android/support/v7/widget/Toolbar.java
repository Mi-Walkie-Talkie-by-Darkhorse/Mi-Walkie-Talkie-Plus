...
public class Toolbar extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i16 = i12 + max3;
        int max5 = Math.max(i10, i13) + getPaddingTop() + getPaddingBottom();
        int resolveSizeAndState = ViewCompat.resolveSizeAndState(Math.max(i16 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, -16777216 & i11);
        int resolveSizeAndState2 = ViewCompat.resolveSizeAndState(Math.max(max5, getSuggestedMinimumHeight()), i2, i11 << 16);
        if (shouldCollapse()) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i19 = minimumHeight >= 0 ? Math.min(minimumHeight, i4 - i2) : 0;
        if (!shouldLayout(this.mNavButtonView)) {
            i5 = i18;
            i6 = paddingLeft;
        } else if (z2) {
            i5 = layoutChildRight(this.mNavButtonView, i18, iArr, i19);
            i6 = paddingLeft;
        } else {
            int i20 = i18;
            i6 = layoutChildLeft(this.mNavButtonView, paddingLeft, iArr, i19);
            i5 = i20;
        }
        if (shouldLayout(this.mCollapseButtonView)) {
            if (z2) {
                i5 = layoutChildRight(this.mCollapseButtonView, i5, iArr, i19);
            } else {
                i6 = layoutChildLeft(this.mCollapseButtonView, i6, iArr, i19);
            }
        }
        if (shouldLayout(this.mMenuView)) {
            if (z2) {
                i6 = layoutChildLeft(this.mMenuView, i6, iArr, i19);
            } else {
                i5 = layoutChildRight(this.mMenuView, i5, iArr, i19);
            }
        }
        ...
        int min = Math.min(i5, (width - paddingRight) - currentContentInsetRight);
        if (shouldLayout(this.mExpandedActionView)) {
            if (z2) {
                min = layoutChildRight(this.mExpandedActionView, min, iArr, i19);
            } else {
                max = layoutChildLeft(this.mExpandedActionView, max, iArr, i19);
            }
        }
        if (!shouldLayout(this.mLogoView)) {
            i7 = min;
            ...
            i7 = layoutChildRight(this.mLogoView, min, iArr, i19);
            i8 = max;
        } else {
            i7 = min;
            i8 = layoutChildLeft(this.mLogoView, max, iArr, i19);
        }
        ...
        if (shouldLayout) {
            ...
            i21 = 0 + layoutParams.bottomMargin + layoutParams.topMargin + this.mTitleTextView.getMeasuredHeight();
        }
        if (shouldLayout2) {
            LayoutParams layoutParams2 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
            i9 = layoutParams2.bottomMargin + layoutParams2.topMargin + this.mSubtitleTextView.getMeasuredHeight() + i21;
        } else {
            i9 = i21;
        }
        if (shouldLayout || shouldLayout2) {
                ...
                default:
                    ...
                    if (i22 < layoutParams3.topMargin + this.mTitleMarginTop) {
                        ...
                        if (i23 < layoutParams3.bottomMargin + this.mTitleMarginBottom) {
                            i17 = Math.max(0, i22 - ((layoutParams4.bottomMargin + this.mTitleMarginBottom) - i23));
                        } else {
                            i17 = i22;
                        }
                    }
            ...
            if (z2) {
                ...
                if (shouldLayout2) {
                    ...
                    int i26 = layoutParams6.bottomMargin + measuredHeight2;
                ...
                if (shouldLayout) {
                    ...
                    int i28 = layoutParams7.bottomMargin + measuredHeight3;
                ...
                if (shouldLayout2) {
                    ...
                    int i29 = i12 + layoutParams8.topMargin;
        ...
        for (int i32 = 0; i32 < size; i32++) {
            i31 = layoutChildLeft((View) this.mTempViews.get(i32), i31, iArr, i19);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i33 = 0; i33 < size2; i33++) {
            i7 = layoutChildRight((View) this.mTempViews.get(i33), i7, iArr, i19);
        }
        ...
        for (int i37 = 0; i37 < size3; i37++) {
            i36 = layoutChildLeft((View) this.mTempViews.get(i37), i36, iArr, i19);
        }
