...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                this.mCustomView.measure(MeasureSpec.makeMeasureSpec(paddingLeft, i3), MeasureSpec.makeMeasureSpec(i4, i5));
            }
            if (this.mContentHeight <= 0) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mMenuView != null) {
            int positionChild2 = positionChild(this.mMenuView, paddingRight, paddingTop, paddingTop2, !isLayoutRtl) + paddingRight;
        }
    }
