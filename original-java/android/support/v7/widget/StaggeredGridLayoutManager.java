...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    public boolean checkForGaps() {
        ...
        if (firstChildPosition == 0 && hasGapsToFix() != null) {
            ...
            FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, lastChildPosition + 1, i, true);
            if (firstFullSpanItemInRange == null) {
                this.mLaidOutInvalidFullSpan = false;
                this.mLazySpanLookup.forceInvalidateAfter(lastChildPosition + 1);
                return false;
            }
            FullSpanItem firstFullSpanItemInRange2 = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, firstFullSpanItemInRange.mPosition, i * -1, true);
    ...
    private void updateLayoutState(int r7, android.support.v7.widget.RecyclerView.State r8) {
        /*
            ...
            int r0 = r8.getTargetScrollPosition()
            r2 = -1
        ...
        L_0x001c:
            ...
            r2 = r1
        L_0x0025:
            boolean r4 = r6.getClipToPadding()
            if (r4 == 0) goto L_0x006b
            android.support.v7.widget.LayoutState r4 = r6.mLayoutState
            android.support.v7.widget.OrientationHelper r5 = r6.mPrimaryOrientation
            int r5 = r5.getStartAfterPadding()
            int r2 = r5 - r2
            r4.mStartLine = r2
            android.support.v7.widget.LayoutState r2 = r6.mLayoutState
        ...
        L_0x0042:
            ...
            r0.mRecycle = r3
            android.support.v7.widget.LayoutState r0 = r6.mLayoutState
            android.support.v7.widget.OrientationHelper r2 = r6.mPrimaryOrientation
            int r2 = r2.getMode()
    ...
    private void handleUpdate(int i, int i2, int i3) {
        int i4;
        int i5;
        int firstChildPosition = this.mShouldReverseLayout ? getLastChildPosition() : getFirstChildPosition();
        if (i3 != 8) {
            i4 = i + i2;
            i5 = i;
        } else if (i < i2) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                if (!z2 || !layoutParams.mFullSpan) {
                    ...
                    FullSpanItem createFullSpanItemFromEnd = createFullSpanItemFromEnd(endLine);
                ...
                if (z2 && layoutParams.mFullSpan) {
                    FullSpanItem createFullSpanItemFromStart = createFullSpanItemFromStart(startLine);
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (z2) {
                    ...
                    boolean z3 = layoutState.mLayoutDirection == 1 ? !areAllEndsEqual() : !areAllStartsEqual();
                    if (z3) {
