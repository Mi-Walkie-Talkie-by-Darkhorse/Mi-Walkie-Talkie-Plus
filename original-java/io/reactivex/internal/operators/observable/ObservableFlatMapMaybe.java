...
public final class ObservableFlatMapMaybe<T, R> extends a<T, R> {
    final g<? super T, ? extends i<? extends R>> b;
    final boolean c;

    static final class FlatMapMaybeObserver<T, R> extends AtomicInteger implements b, q<T> {
        ...
        final g<? super T, ? extends i<? extends R>> f;
        ...
        FlatMapMaybeObserver(q<? super R> qVar, g<? super T, ? extends i<? extends R>> gVar, boolean z) {
            this.a = qVar;
            this.f = gVar;
            this.b = z;
        }
        ...
        public void onNext(T t) {
            try {
                i iVar = (i) io.reactivex.internal.functions.a.a(this.f.apply(t), "The mapper returned a null MaybeSource");
    ...
    public ObservableFlatMapMaybe(o<T> oVar, g<? super T, ? extends i<? extends R>> gVar, boolean z) {
        super(oVar);
        this.b = gVar;
        this.c = z;
    }
    ...
    public void subscribeActual(q<? super R> qVar) {
        this.a.subscribe(new FlatMapMaybeObserver(qVar, this.b, this.c));
    }
}
