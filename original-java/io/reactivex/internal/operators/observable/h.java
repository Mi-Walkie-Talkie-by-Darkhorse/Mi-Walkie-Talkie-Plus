...
public final class h<T> extends s<Boolean> implements io.reactivex.internal.a.a<Boolean> {
    final o<T> a;
    final p<? super T> b;
    ...
    public h(o<T> oVar, p<? super T> pVar) {
        this.a = oVar;
        this.b = pVar;
    }
    ...
    public k<Boolean> f_() {
        return io.reactivex.d.a.a((k<T>) new g<T>(this.a, this.b));
    }
}
