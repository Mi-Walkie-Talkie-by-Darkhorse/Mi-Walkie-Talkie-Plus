...
public final class ObservableSequenceEqual<T> extends k<Boolean> {
    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements b {
        ...
        EqualCoordinator(q<? super Boolean> qVar, int i2, o<? extends T> oVar, o<? extends T> oVar2, d<? super T, ? super T> dVar) {
            this.a = qVar;
            this.d = oVar;
            this.e = oVar2;
            this.b = dVar;
    ...
    public ObservableSequenceEqual(o<? extends T> oVar, o<? extends T> oVar2, d<? super T, ? super T> dVar, int i) {
        this.a = oVar;
        this.b = oVar2;
        this.c = dVar;
        this.d = i;
    ...
    public void subscribeActual(q<? super Boolean> qVar) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(qVar, this.d, this.a, this.b, this.c);
