...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final class Segment<K, V> extends ReentrantLock {
        ...
        public V get(Object obj, int i) {
            if (this.count != 0) {
                HashEntry<K, V>[] hashEntryArr = this.table;
                HashEntry<K, V> hashEntry = hashEntryArr[(hashEntryArr.length - 1) & i];
                if (hashEntryArr != this.table) {
                    return get(obj, i);
                }
                HashEntry<K, V> hashEntry2 = hashEntry;
                while (hashEntry2 != null) {
                    if (hashEntry2.hash != i || !keyEq(obj, hashEntry2.key())) {
                        hashEntry2 = hashEntry2.next;
                    } else {
                        V value = hashEntry2.value();
                        if (value == null) {
                            return readValueUnderLock(hashEntry2);
                        }
                        return value;
                    }
                }
        ...
        public boolean containsKey(Object obj, int i) {
            if (this.count != 0) {
                ...
                for (HashEntry<K, V> hashEntry = hashEntryArr[(hashEntryArr.length - 1) & i]; hashEntry != null; hashEntry = hashEntry.next) {
    ...
    public boolean containsValue(java.lang.Object r9) {
        /*
            ...
            throw r0
        L_0x000a:
            org.jboss.netty.util.internal.ConcurrentIdentityHashMap$Segment<K, V>[] r5 = r8.segments
            int r0 = r5.length
            int[] r6 = new int[r0]
            r4 = r1
        L_0x0010:
