...
public class WebSocketServerHandshaker08 extends WebSocketServerHandshaker {
    ...
    public ChannelFuture handshake(Channel channel, HttpRequest httpRequest) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(String.format("WS Version 8 Server Handshake key: %s. Response: %s.", new Object[]{header, base64}));
        }
        ...
        write.addListener(new ChannelFutureListener() {
            public void operationComplete(ChannelFuture channelFuture) {
                ...
                pipeline.replace(HttpResponseEncoder.class, "wsencoder", (ChannelHandler) new WebSocket08FrameEncoder(false));
            }
        });
        return write;
    }
