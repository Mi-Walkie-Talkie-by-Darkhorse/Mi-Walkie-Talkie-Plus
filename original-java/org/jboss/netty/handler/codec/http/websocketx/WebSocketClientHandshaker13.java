...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
    ...
    public ChannelFuture handshake(Channel channel) throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(String.format("WS Version 13 Client Handshake key: %s. Expected response: %s.", new Object[]{base64, this.expectedChallengeResponseString}));
        }
        ...
        defaultHttpRequest.addHeader(Names.SEC_WEBSOCKET_VERSION, Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        ...
        write.addListener(new ChannelFutureListener() {
            public void operationComplete(ChannelFuture channelFuture) {
                channelFuture.getChannel().getPipeline().replace(HttpRequestEncoder.class, "ws-encoder", (ChannelHandler) new WebSocket13FrameEncoder(true));
