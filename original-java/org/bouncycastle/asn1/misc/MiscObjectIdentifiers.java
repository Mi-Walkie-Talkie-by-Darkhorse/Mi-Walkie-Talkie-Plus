...
public interface MiscObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier netscapeCApolicyURL = netscape.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    public static final ASN1ObjectIdentifier netscapeCertComment = netscape.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
    ...
    public static final ASN1ObjectIdentifier netscapeSSLServerName = netscape.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
