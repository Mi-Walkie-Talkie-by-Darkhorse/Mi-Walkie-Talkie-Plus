...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier certTypes = pkcs_9.branch(Constants.VIA_REPORT_TYPE_DATALINE);
    public static final ASN1ObjectIdentifier crlBag = bagtypes.branch("4");
    public static final ASN1ObjectIdentifier crlTypes = pkcs_9.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
    ...
    public static final ASN1ObjectIdentifier id_PBES2 = pkcs_5.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
    public static final ASN1ObjectIdentifier id_PBKDF2 = pkcs_5.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
    public static final ASN1ObjectIdentifier id_RSAES_OAEP = pkcs_1.branch("7");
    public static final ASN1ObjectIdentifier id_RSASSA_PSS = pkcs_1.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
    ...
    public static final ASN1ObjectIdentifier id_aa_contentReference = id_aa.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
    public static final ASN1ObjectIdentifier id_aa_encrypKeyPref = id_aa.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
    ...
    public static final ASN1ObjectIdentifier id_aa_ets_certValues = id_aa.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
    public static final ASN1ObjectIdentifier id_aa_ets_certificateRefs = id_aa.branch(Constants.VIA_REPORT_TYPE_QQFAVORITES);
    public static final ASN1ObjectIdentifier id_aa_ets_commitmentType = id_aa.branch(Constants.VIA_REPORT_TYPE_START_WAP);
    ...
    public static final ASN1ObjectIdentifier id_aa_ets_otherSigCert = id_aa.branch(Constants.VIA_ACT_TYPE_NINETEEN);
    public static final ASN1ObjectIdentifier id_aa_ets_revocationRefs = id_aa.branch(Constants.VIA_REPORT_TYPE_DATALINE);
    public static final ASN1ObjectIdentifier id_aa_ets_revocationValues = id_aa.branch("24");
    public static final ASN1ObjectIdentifier id_aa_ets_sigPolicyId = id_aa.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
    public static final ASN1ObjectIdentifier id_aa_ets_signerAttr = id_aa.branch("18");
    public static final ASN1ObjectIdentifier id_aa_ets_signerLocation = id_aa.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
    ...
    public static final ASN1ObjectIdentifier id_aa_signatureTimeStampToken = id_aa.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
    public static final ASN1ObjectIdentifier id_aa_signerLocation = id_aa_ets_signerLocation;
    public static final ASN1ObjectIdentifier id_aa_signingCertificate = id_aa.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
    ...
    public static final ASN1ObjectIdentifier id_ct_authEnvelopedData = id_ct.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
    ...
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfCreation = id_cti.branch(Constants.VIA_SHARE_TYPE_INFO);
    ...
    public static final ASN1ObjectIdentifier id_hmacWithSHA224 = digestAlgorithm.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO).intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA256 = digestAlgorithm.branch("9").intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA384 = digestAlgorithm.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ).intern();
    public static final ASN1ObjectIdentifier id_hmacWithSHA512 = digestAlgorithm.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE).intern();
    public static final ASN1ObjectIdentifier id_mgf1 = pkcs_1.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    public static final ASN1ObjectIdentifier id_pSpecified = pkcs_1.branch("9");
    public static final ASN1ObjectIdentifier id_rsa_KEM = id_alg.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
    public static final ASN1ObjectIdentifier id_smime = pkcs_9.branch(Constants.VIA_REPORT_TYPE_START_WAP).intern();
    ...
    public static final ASN1ObjectIdentifier pbeWithMD5AndRC2_CBC = pkcs_5.branch(Constants.VIA_SHARE_TYPE_INFO);
    public static final ASN1ObjectIdentifier pbeWithSHA1AndDES_CBC = pkcs_5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
    public static final ASN1ObjectIdentifier pbeWithSHA1AndRC2_CBC = pkcs_5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
    ...
    public static final ASN1ObjectIdentifier pbeWithSHAAnd40BitRC2_CBC = pkcs_12PbeIds.branch(Constants.VIA_SHARE_TYPE_INFO);
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_counterSignature = pkcs_9.branch(Constants.VIA_SHARE_TYPE_INFO).intern();
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_extensionRequest = pkcs_9.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_friendlyName = pkcs_9.branch("20").intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_localKeyId = pkcs_9.branch(Constants.VIA_REPORT_TYPE_QQFAVORITES).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_messageDigest = pkcs_9.branch("4").intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_signingDescription = pkcs_9.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_signingTime = pkcs_9.branch("5").intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_smimeCapabilities = pkcs_9.branch(Constants.VIA_REPORT_TYPE_WPA_STATE).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredAddress = pkcs_9.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO).intern();
    ...
    public static final ASN1ObjectIdentifier safeContentsBag = bagtypes.branch(Constants.VIA_SHARE_TYPE_INFO);
    ...
    public static final ASN1ObjectIdentifier sha224WithRSAEncryption = pkcs_1.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
    public static final ASN1ObjectIdentifier sha256WithRSAEncryption = pkcs_1.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
    public static final ASN1ObjectIdentifier sha384WithRSAEncryption = pkcs_1.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
    public static final ASN1ObjectIdentifier sha512WithRSAEncryption = pkcs_1.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
    ...
    public static final ASN1ObjectIdentifier srsaOAEPEncryptionSET = pkcs_1.branch(Constants.VIA_SHARE_TYPE_INFO);
