...
public interface TeleTrusTObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier brainpoolP224t1 = versionOne.branch(Constants.VIA_SHARE_TYPE_INFO);
    public static final ASN1ObjectIdentifier brainpoolP256r1 = versionOne.branch("7");
    public static final ASN1ObjectIdentifier brainpoolP256t1 = versionOne.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    public static final ASN1ObjectIdentifier brainpoolP320r1 = versionOne.branch("9");
    public static final ASN1ObjectIdentifier brainpoolP320t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
    public static final ASN1ObjectIdentifier brainpoolP384r1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
    public static final ASN1ObjectIdentifier brainpoolP384t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
    public static final ASN1ObjectIdentifier brainpoolP512r1 = versionOne.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
    public static final ASN1ObjectIdentifier brainpoolP512t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
