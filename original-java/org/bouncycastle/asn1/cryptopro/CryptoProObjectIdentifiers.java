...
public interface CryptoProObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier gostR28147_gcfb = GOST_id.branch(Constants.VIA_REPORT_TYPE_QQFAVORITES);
    public static final ASN1ObjectIdentifier gostR3410_2001 = GOST_id.branch(Constants.VIA_ACT_TYPE_NINETEEN);
    ...
    public static final ASN1ObjectIdentifier gostR3411Hmac = GOST_id.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
