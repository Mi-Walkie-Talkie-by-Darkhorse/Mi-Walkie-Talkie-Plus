...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f3cn = new ASN1ObjectIdentifier("2.5.4.3").intern();
    ...
    static {
        ...
        DefaultSymbols.put(f3cn, "cn");
        DefaultSymbols.put(dc, "dc");
        DefaultSymbols.put(description, SocialConstants.PARAM_COMMENT);
        ...
        DefaultSymbols.put(name, HttpPostBodyUtil.NAME);
        ...
        DefaultSymbols.put(uid, Key.UID);
        ...
        DefaultLookUp.put("cn", f3cn);
        DefaultLookUp.put("dc", dc);
        DefaultLookUp.put(SocialConstants.PARAM_COMMENT, description);
