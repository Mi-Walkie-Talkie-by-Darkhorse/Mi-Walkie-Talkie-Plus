...
public interface IANAObjectIdentifiers {
    public static final ASN1ObjectIdentifier SNMPv2 = internet.branch(Constants.VIA_SHARE_TYPE_INFO);
    ...
    public static final ASN1ObjectIdentifier ipsec = security_mechanisms.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    ...
    public static final ASN1ObjectIdentifier pkix = security_mechanisms.branch(Constants.VIA_SHARE_TYPE_INFO);
    ...
    public static final ASN1ObjectIdentifier security_nametypes = security.branch(Constants.VIA_SHARE_TYPE_INFO);
}
