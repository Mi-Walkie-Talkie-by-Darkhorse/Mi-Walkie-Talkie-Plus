...
public interface SECObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier secp112r1 = ellipticCurve.branch(Constants.VIA_SHARE_TYPE_INFO);
    public static final ASN1ObjectIdentifier secp112r2 = ellipticCurve.branch("7");
    public static final ASN1ObjectIdentifier secp128r1 = ellipticCurve.branch(Constants.VIA_ACT_TYPE_TWENTY_EIGHT);
    ...
    public static final ASN1ObjectIdentifier secp160r1 = ellipticCurve.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    ...
    public static final ASN1ObjectIdentifier secp256k1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
    ...
    public static final ASN1ObjectIdentifier sect131r1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_DATALINE);
    public static final ASN1ObjectIdentifier sect131r2 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
    ...
    public static final ASN1ObjectIdentifier sect163r2 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
    ...
    public static final ASN1ObjectIdentifier sect283k1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_START_WAP);
    public static final ASN1ObjectIdentifier sect283r1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
