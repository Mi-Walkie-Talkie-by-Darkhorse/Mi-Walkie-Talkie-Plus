...
public class BrokenJCEBlockCipher implements BrokenPBE {
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof BCPBEKey) {
            CipherParameters makePBEParameters = Util.makePBEParameters((BCPBEKey) key, algorithmParameterSpec, this.pbeType, this.pbeHash, this.cipher.getUnderlyingCipher().getAlgorithmName(), this.pbeKeySize, this.pbeIvSize);
            if (this.pbeIvSize != 0) {
            ...
            CipherParameters rC2Parameters = new RC2Parameters(key.getEncoded(), ((RC2ParameterSpec) algorithmParameterSpec).getEffectiveKeyBits());
            if (rC2ParameterSpec.getIV() == null || this.ivLength == 0) {
                cipherParameters3 = rC2Parameters;
            } else {
                cipherParameters3 = new ParametersWithIV(rC2Parameters, rC2ParameterSpec.getIV());
                this.ivParam = (ParametersWithIV) cipherParameters3;
            }
            cipherParameters2 = cipherParameters3;
        } else if (algorithmParameterSpec instanceof RC5ParameterSpec) {
            RC5ParameterSpec rC5ParameterSpec = (RC5ParameterSpec) algorithmParameterSpec;
            CipherParameters rC5Parameters = new RC5Parameters(key.getEncoded(), ((RC5ParameterSpec) algorithmParameterSpec).getRounds());
        ...
        if (this.ivLength != 0 && !(cipherParameters2 instanceof ParametersWithIV)) {
            ...
            if (i == 1 || i == 3) {
                ...
                ParametersWithIV parametersWithIV2 = new ParametersWithIV(cipherParameters2, bArr);
