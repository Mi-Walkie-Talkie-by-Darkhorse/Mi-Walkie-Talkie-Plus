...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    public int originalHashCode() {
        /*
            r5 = this;
            r1 = 0
            byte[] r4 = r5.getEncoded()     // Catch:{ CertificateEncodingException -> 0x0014 }
            r0 = 1
            r2 = r0
            r0 = r1
        L_0x0008:
            int r3 = r4.length     // Catch:{ CertificateEncodingException -> 0x0014 }
            if (r2 >= r3) goto L_0x0016
            byte r3 = r4[r2]     // Catch:{ CertificateEncodingException -> 0x0014 }
            int r3 = r3 * r2
            int r3 = r3 + r0
            int r0 = r2 + 1
            r2 = r0
        ...
        L_0x0016:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateObject.originalHashCode():int");
    }
