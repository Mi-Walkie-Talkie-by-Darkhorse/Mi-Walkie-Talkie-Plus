...
public class SkeinEngine implements Memoable {
    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i) {
            if (this.extendedPosition) {
                long[] jArr = {this.tweak[0] & 4294967295L, (this.tweak[0] >>> 32) & 4294967295L, this.tweak[1] & 4294967295L};
                long j = (long) i;
                for (int i2 = 0; i2 < jArr.length; i2++) {
                    long j2 = j + jArr[i2];
                    jArr[i2] = j2;
        ...
        public void setFinal(boolean z) {
            ...
            jArr2[1] = jArr2[1] & FileTracerConfig.FOREVER;
        }
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            output((long) i3, bArr, i + (i3 * blockSize), Math.min(blockSize, this.outputSizeBytes - (i3 * blockSize)));
        }
        reset();
