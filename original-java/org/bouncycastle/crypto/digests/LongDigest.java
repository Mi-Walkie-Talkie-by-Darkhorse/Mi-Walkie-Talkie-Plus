...
public abstract class LongDigest implements ExtendedDigest, EncodableDigest, Memoable {
    ...
    public void processBlock() {
        ...
        while (true) {
            ...
            int i5 = i4 + 1;
            long Sum1 = j8 + this.W[i4] + Sum1(j5) + Ch(j5, j6, j7) + K[i4];
            long j10 = j4 + Sum1;
            long Maj = Maj(j9, j2, j3) + Sum0(j9) + Sum1;
            int i6 = i5 + 1;
            long Ch = j7 + Ch(j10, j5, j6) + Sum1(j10) + K[i5] + this.W[i5];
            long j11 = j3 + Ch;
            long Maj2 = Maj(Maj, j9, j2) + Sum0(Maj) + Ch;
            int i7 = i6 + 1;
            long Ch2 = j6 + Ch(j11, j10, j5) + Sum1(j11) + K[i6] + this.W[i6];
            long j12 = j2 + Ch2;
            long Maj3 = Maj(Maj2, Maj, j9) + Sum0(Maj2) + Ch2;
            int i8 = i7 + 1;
            long Ch3 = j5 + Ch(j12, j11, j10) + Sum1(j12) + K[i7] + this.W[i7];
            long j13 = j9 + Ch3;
            long Maj4 = Maj(Maj3, Maj2, Maj) + Sum0(Maj3) + Ch3;
            int i9 = i8 + 1;
            long Ch4 = j10 + Ch(j13, j12, j11) + Sum1(j13) + K[i8] + this.W[i8];
            long j14 = Maj + Ch4;
            j4 = Ch4 + Sum0(Maj4) + Maj(Maj4, Maj3, Maj2);
            int i10 = i9 + 1;
            long Ch5 = j11 + Ch(j14, j13, j12) + Sum1(j14) + K[i9] + this.W[i9];
            long j15 = Maj2 + Ch5;
            long Sum0 = Ch5 + Sum0(j4) + Maj(j4, Maj4, Maj3);
            int i11 = i10 + 1;
            long Ch6 = j12 + Ch(j15, j14, j13) + Sum1(j15) + K[i10] + this.W[i10];
            long j16 = Maj3 + Ch6;
            long Sum02 = Ch6 + Sum0(Sum0) + Maj(Sum0, j4, Maj4);
            i2 = i11 + 1;
            long Ch7 = Ch(j16, j15, j14) + Sum1(j16) + K[i11] + this.W[i11] + j13;
            j5 = Maj4 + Ch7;
            long Maj5 = Ch7 + Maj(Sum02, Sum0, j4) + Sum0(Sum02);
            i3++;
            j2 = Sum02;
            j3 = Sum0;
            j8 = j14;
