...
public class HC128Engine implements StreamCipher {
    ...
    private static int mod1024(int i) {
        return i & GLMapStaticValue.AM_PARAMETERNAME_PROCESS_ROADARROW;
    }

    private static int mod512(int i) {
        return i & Error.E_WTSDK_IS_BUSY;
    }
    ...
    private int step() {
        ...
        if (this.cnt < 512) {
            int[] iArr = this.p;
            iArr[mod512] = iArr[mod512] + g1(this.p[dim(mod512, 3)], this.p[dim(mod512, 10)], this.p[dim(mod512, Error.E_WTSDK_IS_BUSY)]);
            h2 = this.p[mod512] ^ h1(this.p[dim(mod512, 12)]);
        } else {
            int[] iArr2 = this.q;
            iArr2[mod512] = iArr2[mod512] + g2(this.q[dim(mod512, 3)], this.q[dim(mod512, 10)], this.q[dim(mod512, Error.E_WTSDK_IS_BUSY)]);
