...
public class SecT571Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        for (int i2 = 7; i2 > 0; i2--) {
            i += 18;
            Nat.shiftUpBit64(9, jArr4, i >>> 1, 0, jArr4, i);
            reduce5(jArr4, i);
            add(jArr4, 9, jArr4, i, jArr4, i + 9);
        }
        ...
        for (int i3 = 56; i3 >= 0; i3 -= 8) {
            for (int i4 = 1; i4 < 9; i4 += 2) {
                ...
                long[] jArr6 = jArr4;
                long[] jArr7 = jArr3;
                addBothTo(jArr6, (i5 & 15) * 9, jArr5, ((i5 >>> 4) & 15) * 9, jArr7, i4 - 1);
            }
        ...
        for (int i6 = 56; i6 >= 0; i6 -= 8) {
            for (int i7 = 0; i7 < 9; i7 += 2) {
                ...
                long[] jArr8 = jArr4;
                addBothTo(jArr8, (i8 & 15) * 9, jArr5, ((i8 >>> 4) & 15) * 9, jArr3, i7);
            }
            if (i6 > 0) {
