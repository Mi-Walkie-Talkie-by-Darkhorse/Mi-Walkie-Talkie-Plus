...
public class SecP384R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j14 = j6 - j8;
        long j15 = j7 - j8;
        long j16 = 0 + (((long) iArr[0]) & M) + j9 + j14;
        iArr2[0] = (int) j16;
        long j17 = ((j8 + (((long) iArr[1]) & M)) - j9) + j10 + (j16 >> 32);
        iArr2[1] = (int) j17;
        long j18 = (j17 >> 32) + (((((long) iArr[2]) & M) - j6) - j10) + j11;
        iArr2[2] = (int) j18;
        long j19 = (j18 >> 32) + (((((long) iArr[3]) & M) + j9) - j11) + j12 + j14;
        iArr2[3] = (int) j19;
        long j20 = ((((j6 + ((((long) iArr[4]) & M) + j)) + j9) + j10) - j12) + j14 + (j19 >> 32);
        iArr2[4] = (int) j20;
        long j21 = (j20 >> 32) + ((((long) iArr[5]) & M) - j) + j10 + j11 + j13;
        iArr2[5] = (int) j21;
        long j22 = (j21 >> 32) + (((((long) iArr[6]) & M) + j3) - j2) + j11 + j12;
        iArr2[6] = (int) j22;
        long j23 = (j22 >> 32) + ((((((long) iArr[7]) & M) + j) + j4) - j3) + j12;
        iArr2[7] = (int) j23;
        long j24 = ((((j + (((long) iArr[8]) & M)) + j2) + j5) - j4) + (j23 >> 32);
        iArr2[8] = (int) j24;
        long j25 = (j24 >> 32) + (((((long) iArr[9]) & M) + j3) - j5) + j13;
        iArr2[9] = (int) j25;
        long j26 = (j25 >> 32) + ((((((long) iArr[10]) & M) + j3) + j4) - j14) + j15;
        iArr2[10] = (int) j26;
        long j27 = (j26 >> 32) + ((((((long) iArr[11]) & M) + j4) + j5) - j15);
        iArr2[11] = (int) j27;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            iArr[3] = (int) j7;
            long j8 = (j7 >> 32) + j2 + (((long) iArr[4]) & M);
            iArr[4] = (int) j8;
            j = j8 >> 32;
        } else {
            j = 0;
