...
public class SecT283K1Point extends AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SecT283K1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{eCFieldElement5}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT283K1Point(curve, square2, square3.add(multiply).add(square).multiply(square3).add(isOne ? eCFieldElement3 : square.square()).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
