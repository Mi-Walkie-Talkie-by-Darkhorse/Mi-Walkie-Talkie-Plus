...
public class SecP224R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j8 = 0 + ((((long) iArr[0]) & M) - j5);
        long j9 = M & j8;
        long j10 = (j8 >> 32) + ((((long) iArr[1]) & M) - j6);
        iArr2[1] = (int) j10;
        long j11 = (j10 >> 32) + ((((long) iArr[2]) & M) - j7);
        iArr2[2] = (int) j11;
        long j12 = ((j5 + (((long) iArr[3]) & M)) - j) + (j11 >> 32);
        long j13 = M & j12;
        long j14 = ((j6 + (((long) iArr[4]) & M)) - j2) + (j12 >> 32);
        iArr2[4] = (int) j14;
        long j15 = (j14 >> 32) + (((((long) iArr[5]) & M) + j7) - j3);
        iArr2[5] = (int) j15;
        long j16 = ((j + (((long) iArr[6]) & M)) - j4) + (j15 >> 32);
        iArr2[6] = (int) j16;
        long j17 = 1 + (j16 >> 32);
        long j18 = j13 + j17;
        long j19 = j9 - j17;
        ...
        if (j20 != 0) {
            ...
            iArr2[1] = (int) j21;
            long j22 = (j21 >> 32) + (((long) iArr2[2]) & M);
            iArr2[2] = (int) j22;
            j18 += j22 >> 32;
        }
        iArr2[3] = (int) j18;
        if ((j18 >> 32) == 0 || Nat.incAt(7, iArr2, 4) == 0) {
            if (iArr2[6] == -1) {
