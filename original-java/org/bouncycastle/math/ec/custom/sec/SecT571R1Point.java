...
public class SecT571R1Point extends AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply.isZero()) {
                return new SecT571R1Point(curve, multiply, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            }
        ...
        return new SecT571R1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{eCFieldElement5}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT571R1Point(curve, square2, (isOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
