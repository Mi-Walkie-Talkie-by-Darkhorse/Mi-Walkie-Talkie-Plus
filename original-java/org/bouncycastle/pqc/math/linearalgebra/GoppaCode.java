...
public final class GoppaCode {
    ...
    public static GF2Matrix createCanonicalCheckMatrix(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, new int[]{degree2, i});
        int[][] iArr2 = (int[][]) Array.newInstance(Integer.TYPE, new int[]{degree2, i});
        ...
        int[][] iArr3 = (int[][]) Array.newInstance(Integer.TYPE, new int[]{degree2 * degree, (i + 31) >>> 5});
