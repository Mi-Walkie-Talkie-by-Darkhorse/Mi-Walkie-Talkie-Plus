...
public class GMSSLeaf {
    ...
    private void updateLeafCalc() {
        ...
        throw new IllegalStateException("unable to updateLeaf in steps: " + this.steps + Token.SEPARATOR + this.i + Token.SEPARATOR + this.j);
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            str = str + getStatInt()[i2] + Token.SEPARATOR;
        }
        String str2 = str + Token.SEPARATOR + this.mdsize + Token.SEPARATOR + this.keysize + Token.SEPARATOR + this.two_power_w + Token.SEPARATOR;
        byte[][] statByte = getStatByte();
        String str3 = str2;
        for (int i3 = 0; i3 < 4; i3++) {
            str3 = statByte[i3] != null ? str3 + new String(Hex.encode(statByte[i3])) + Token.SEPARATOR : str3 + "null ";
        }
        return str3;
    }
}
