    ...
    private ParSet(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence2.size() == this.t && aSN1Sequence3.size() == this.t && aSN1Sequence4.size() == this.t) {
            ...
            while (true) {
                int i2 = i;
                if (i2 < this.t) {
                    this.h[i2] = checkBigIntegerInIntRangeAndPositive(((ASN1Integer) aSN1Sequence2.getObjectAt(i2)).getValue());
                    this.w[i2] = checkBigIntegerInIntRangeAndPositive(((ASN1Integer) aSN1Sequence3.getObjectAt(i2)).getValue());
                    this.k[i2] = checkBigIntegerInIntRangeAndPositive(((ASN1Integer) aSN1Sequence4.getObjectAt(i2)).getValue());
                    i = i2 + 1;
                } else {
                    return;
                }
